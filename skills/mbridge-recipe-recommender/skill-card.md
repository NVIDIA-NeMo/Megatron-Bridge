...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers selecting and customizing Megatron Bridge training recipes for their specific model, GPU configuration, and training objective (pretrain, SFT, or PEFT). <br>
