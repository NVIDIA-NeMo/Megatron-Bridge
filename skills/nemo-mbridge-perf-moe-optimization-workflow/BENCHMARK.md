...
Evaluation of the `nemo-mbridge-perf-moe-optimization-workflow` skill before publication through Skill Evaluator.
...
- LOW SCHEMA/unexpected_file: Unexpected 'card.yaml' in skill root (`skills/nemo-mbridge-perf-moe-optimization-workflow/card.yaml`)
