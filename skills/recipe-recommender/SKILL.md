...
when_to_use: When a user asks which recipe to use, how to start training a model, or wants a starting config for a given model, GPU count, and training goal (pretrain/SFT/PEFT).
---
