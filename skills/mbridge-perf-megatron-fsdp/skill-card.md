...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers using FSDP-based data parallelism instead of DDP for distributed LLM training with Megatron-Bridge, or diagnosing OOM and regression issues related to FSDP configuration changes. <br>
