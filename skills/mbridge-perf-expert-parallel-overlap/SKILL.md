---
name: mbridge-perf-expert-parallel-overlap
...
Card: @skills/mbridge-perf-expert-parallel-overlap/card.yaml

## References

- Stable docs: @docs/training/communication-overlap.md
- Structured metadata: @skills/mbridge-perf-expert-parallel-overlap/card.yaml
