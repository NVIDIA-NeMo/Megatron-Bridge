...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers choosing or sizing TP/DP/PP/CP/EP parallelism degrees for large model training, or tracing OOM errors and performance regressions to parallelism configuration changes in Megatron Bridge. <br>
