...
Stable docs: @docs/training/mbridge-resiliency.md, @docs/training/checkpointing.md
Card: @skills/mbridge-resiliency/card.yaml
...
- Perf plugin: `scripts/performance/mbridge-resiliency_plugins.py`
- Tests: `tests/unit_tests/training/test_fault_tolerance.py`
- Example: `examples/training_features/mbridge-resiliency/fault_tolerance/`
...
- Example: `examples/training_features/mbridge-resiliency/straggler_detection/`
...
### Fault tolerance
```bash
./examples/training_features/mbridge-resiliency/fault_tolerance/run_fault_tolerance.sh
./examples/training_features/mbridge-resiliency/fault_tolerance/run_fault_tolerance.sh --simulate-fault
```
...
uv run python -m torch.distributed.run --nproc_per_node=2 \
    examples/training_features/mbridge-resiliency/straggler_detection/straggler_detection_example.py
```
