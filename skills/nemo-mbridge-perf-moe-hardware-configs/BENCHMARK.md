...
Evaluation of the `nemo-mbridge-perf-moe-hardware-configs` skill before publication through Skill Evaluator.
...
Tier 1 validation passed with observations. Skill Evaluator ran 1 checks and found 4 total findings.
...
- MEDIUM SCHEMA/author_missing: Author not specified in metadata (`skills/nemo-mbridge-perf-moe-hardware-configs/SKILL.md`)
- LOW SCHEMA/unexpected_file: Unexpected 'card.yaml' in skill root (`skills/nemo-mbridge-perf-moe-hardware-configs/card.yaml`)
