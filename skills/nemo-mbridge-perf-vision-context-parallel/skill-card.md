...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers optimizing Vision-Language Model training throughput and memory usage by sharding the vision encoder across context-parallel ranks in Megatron-Bridge. <br>
...
## Reference(s): <br>
- [SKILL.md](skills/nemo-mbridge-perf-vision-context-parallel/SKILL.md) <br>
...
## Evaluation Tasks: <br>
Evaluated against 3 evaluation tasks (2 positive, 1 negative) using evaluator version 1.2.7. <br>
...
|---|---:|---:|
| Overall | 70% → 98% (+28 points) | 79% → 95% (+17 points) |
| Security | 100% → 100% (±0 points) | 100% → 100% (±0 points) |
| Correctness | 33% → 100% (+67 points) | 87% → 93% (+7 points) |
| Discoverability | 100% → 100% (±0 points) | 73% → 96% (+23 points) |
| Effectiveness | 18% → 88% (+70 points) | 53% → 87% (+34 points) |
| Efficiency | 97% → 100% (+3 points) | 80% → 100% (+20 points) |
