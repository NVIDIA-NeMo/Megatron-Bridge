...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers diagnosing GPU out-of-memory errors during Megatron Bridge training runs, reducing peak memory usage, or tracing OOM regressions to specific configuration changes. <br>
...
## Evaluation Tasks: <br>
NVSkills-Eval 3-Tier evaluation with external profile. Tier 1 static validation (9 checks, 10 findings). Tier 2 deduplication (2 checks, 0 findings). Tier 3 live agent evaluation not available. <br>
