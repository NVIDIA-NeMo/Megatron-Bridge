...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers enabling sequence packing or long-context SFT training in Megatron-Bridge, including configuring offline packed SFT for LLMs, in-batch packing for VLMs, and context parallelism constraints. <br>
...
- [Validation Status (card.yaml)](card.yaml) <br>
