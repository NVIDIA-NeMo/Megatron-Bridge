...
- @skills/mbridge-perf-hierarchical-context-parallel/card.yaml
...
No dedicated Bridge end-to-end test exists yet for HCP (see @skills/mbridge-perf-hierarchical-context-parallel/card.yaml
