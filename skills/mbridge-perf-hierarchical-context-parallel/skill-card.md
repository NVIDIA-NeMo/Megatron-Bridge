...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers scaling context parallelism beyond KV heads in Megatron-Bridge, or diagnosing OOM and regression issues related to hierarchical CP configuration changes. <br>
