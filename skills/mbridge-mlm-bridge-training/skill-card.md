...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers running Megatron-LM and Megatron Bridge training side by side, performing loss-correlation testing, translating MLM CLI arguments to Bridge config, and launching multi-GPU training recipes. <br>
