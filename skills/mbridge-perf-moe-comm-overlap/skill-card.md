...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers tuning MoE communication overlap for expert-parallel training workloads in Megatron Bridge, or tracing throughput regressions to comm-overlap configuration changes. <br>
...
## Evaluation Tasks: <br>
Evaluated through NVSkills-Eval 3-Tier Evaluation using the external profile. Tier 1 static validation ran 9 checks; Tier 2 deduplication ran 2 checks. <br>
