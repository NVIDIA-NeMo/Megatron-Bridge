...
HF_MODEL_ID_TO_BRIDGE_MODEL_PROVIDER = {
    # Mamba models
    "state-spaces/mamba-130m-hf": MambaProvider130M,
    "state-spaces/mamba-370m-hf": MambaProvider370M,
    "state-spaces/mamba-790m-hf": MambaProvider780M,
    "state-spaces/mamba-1.4b-hf": MambaProvider1_3B,
    "state-spaces/mamba-2.8b-hf": MambaProvider2_7B,
}


class TestMambaModelProviderMapping:
