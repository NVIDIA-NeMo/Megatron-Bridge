...
class TestQwen3OmniMoeConversion:
    """
    Test Qwen3 Omni Moe model Conversion
    """
    ...
    def test_moe_toy_model_creation(self, qwen3_omni_moe_toy_model_path):
        """Test MoE toy model creation."""
        model_path = Path(qwen3_omni_moe_toy_model_path)
    ...
    def test_moe_conversion(self, qwen3_omni_moe_toy_model_path, tmp_path, tp, pp):
        """Test MoE model conversion."""
        test_output_dir = tmp_path / "qwen3_omni_moe_test"
        ...
        model_name = Path(qwen3_omni_moe_toy_model_path).name
