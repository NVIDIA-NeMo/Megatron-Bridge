...
uv run coverage run --data-file=/opt/Megatron-Bridge/.coverage --source=/opt/Megatron-Bridge/ --parallel-mode -m pytest \
  ...
  tests/functional_tests/models/qwen/test_qwen3_moe_conversion.py \
  tests/functional_tests/models/qwen/test_qwen3_next_conversion.py \
  tests/functional_tests/models/qwen/test_qwen3_next_provider.py
coverage combine -q
