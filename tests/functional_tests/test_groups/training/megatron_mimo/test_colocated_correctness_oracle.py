...
Run:
    torchrun --nproc_per_node=2 -m pytest -v -s -x \\
        tests/functional_tests/test_groups/training/megatron_mimo/test_colocated_correctness_oracle.py
"""
...
def _build_dist_config(par_cfg: MegatronMIMOParallelismConfig) -> ConfigContainer:
    ...
    return ConfigContainer(
        ...
        # The oracle never saves a checkpoint, so skip RNG checkpoint payloads.
