...
def _build_config(
    ...
    # examples/models/megatron_mimo/megatron_mimo/megatron_mimo_training_llava.py: fp32 grad
...
class TestMegatronMIMOTraining:
    ...
    def test_megatron_mimo_tp1_both(self, deterministic):
        ...
        ``examples/models/megatron_mimo/megatron_mimo/megatron_mimo_training_llava.py`` to
