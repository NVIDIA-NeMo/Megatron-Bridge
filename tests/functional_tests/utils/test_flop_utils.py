...
class TestFlops:
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("nemotronh", "nemotronh_8b_pretrain_config", 8192, 131072, 3.82e14),
            ("nemotronh", "nemotronh_47b_pretrain_config", 8192, 131072, 2.29e15),
            ("nemotronh", "nemotronh_56b_pretrain_config", 8192, 131072, 2.78e15),
        ],
    )
