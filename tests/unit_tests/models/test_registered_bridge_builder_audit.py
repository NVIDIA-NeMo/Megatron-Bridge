...
REGISTERED_BRIDGE_CONFIGS: dict[str, tuple[str, ...]] = {
    ...
    "Exaone45Bridge": ("megatron.bridge.models.exaone.exaone45.model_config.Exaone45ModelConfig",),
    "ExaoneMoeBridge": ("megatron.bridge.models.exaone.model_config.ExaoneMoeModelConfig",),
    ...
    "HYV3Bridge": ("megatron.bridge.models.gpt.model_config.BridgeGPTModelConfig",),
    ...
    "MiniMaxM3Bridge": ("megatron.bridge.models.minimax_m3.model_config.MiniMaxM3VLModelConfig",),
...
REGISTERED_BRIDGE_ARCHITECTURES: dict[str, str] = {
    ...
    "Exaone45Bridge": "Exaone4_5_ForConditionalGeneration",
    "ExaoneMoeBridge": "'ExaoneMoEForCausalLM'",
    ...
    "MiniMaxM3Bridge": "'MiniMaxM3SparseForConditionalGeneration'",
