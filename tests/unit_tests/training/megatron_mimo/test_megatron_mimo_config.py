...
def test_colocated_stage2_accepts_language_cp_gt_1():
...
def test_colocated_stage2_rejects_encoder_cp_gt_1():
...
def test_colocated_stage2_rejects_language_cp_with_multiple_modality_modules():
