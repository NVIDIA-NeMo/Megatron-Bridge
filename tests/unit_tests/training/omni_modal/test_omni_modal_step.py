...
"""Unit tests for OmniModal forward step functions."""
...
class TestLossFunc:
    ...
    def test_loss_computation(self):
        ...
        from megatron.bridge.training.omni_modal_step import loss_func
...
class TestGetBatch:
    ...
    def test_returns_none_for_none_iterator(self):
        ...
        from megatron.bridge.training.omni_modal_step import get_batch
...
class TestForwardStep:
    ...
    @patch("megatron.bridge.training.omni_modal_step.unwrap_omni_modal_model")
    def test_forward_step_last_stage(self, mock_unwrap):
        """Test forward step at last pipeline stage returns loss func."""
        from megatron.bridge.training.omni_modal_step import forward_step
        ...
        # unwrap_omni_modal_model returns the mock model itself
