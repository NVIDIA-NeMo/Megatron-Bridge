...
"""Unit tests for OmniModal parallel utilities."""
...
class TestIsCurrentRankInGrid:
    ...
    @patch("megatron.bridge.training.omni_modal_parallel_utils.dist")
...
class TestValidateNoStubRanks:
    ...
    def test_all_ranks_participate(self):
        ...
        from megatron.bridge.training.omni_modal_parallel_utils import validate_no_stub_ranks
...
class TestValidateDataLoaderContract:
    ...
    def test_valid_configuration(self):
        ...
        from megatron.bridge.training.omni_modal_parallel_utils import validate_data_loader_contract
...
class TestBuildPgCollectionForSchedule:
    ...
    def test_fallback_to_list(self):
        ...
        from megatron.bridge.training.omni_modal_parallel_utils import build_pg_collection_for_schedule
...
class TestMultimoduleNoSync:
    ...
    @patch("megatron.bridge.training.omni_modal_parallel_utils.is_current_rank_in_grid")
    def test_enters_and_exits_contexts(self, mock_in_grid):
        """Test that no_sync contexts are properly entered and exited."""
        from megatron.bridge.training.omni_modal_parallel_utils import multimodule_no_sync
...
class TestZeroGradBufferForMultimodule:
    ...
    def test_zeros_grad_buffers(self, mock_in_grid):
        ...
        from megatron.bridge.training.omni_modal_parallel_utils import zero_grad_buffer_for_multimodule
