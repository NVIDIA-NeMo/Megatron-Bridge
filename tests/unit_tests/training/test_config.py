...
"""Unit tests for configuration validation in megatron_hub.training.config."""
...
from megatron_hub.training.config import (
    CheckpointConfig,
    ConfigContainer,
...
def create_test_config_container(
    ...
    import megatron_hub.training.config as config_module
