...
def test_mxfp8_fsdp_recipe_configuration(recipe_factory: Callable[[], ConfigContainer]) -> None:
    """Lightning MXFP8 FSDP variants share the validated sharding contract."""
    cfg = recipe_factory()
