...
from megatron_hub.utils.config_utils import ConfigContainer
from megatron_hub.utils.instantiate_utils import InstantiationMode
...
class TestConfigContainer_FromDict:
    ...
    @patch("megatron_hub.utils.config_utils.instantiate")
...
class TestConfigContainer_FromYaml:
    ...
    @patch("megatron_hub.utils.config_utils.OmegaConf")
    ...
    def test_from_yaml_with_mode(self, mock_exists):
        ...
        with patch("builtins.open", mock_open()):
            with patch("yaml.safe_load", return_value={}):
                with patch("megatron_hub.utils.config_utils.OmegaConf") as mock_omegaconf:
...
class TestConfigContainer_ToYaml:
    ...
    @patch("megatron_hub.utils.config_utils.safe_yaml_representers")
...
class TestConfigContainer_Integration:
    ...
    def test_yaml_roundtrip_structure(self):
        ...
        with patch("megatron_hub.utils.config_utils.safe_yaml_representers"):
