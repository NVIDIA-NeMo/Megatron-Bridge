...
from megatron_hub.utils.import_utils import (
    UnavailableError,
    UnavailableMeta,
    get_torch_version,
    gpu_only_import,
...
class TestTorchVersionUtils:
    ...
    def test_is_torch_min_version_true(self):
        ...
        with patch("megatron_hub.utils.import_utils.get_torch_version", return_value=PkgVersion("2.0.0")):
    ...
    def test_is_torch_min_version_false(self):
        ...
        with patch("megatron_hub.utils.import_utils.get_torch_version", return_value=PkgVersion("1.8.0")):
