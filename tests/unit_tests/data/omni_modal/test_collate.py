...
"""Unit tests for OmniModal collate functions."""
...
class TestOmniModalCollateFn:
    """Test suite for omni_modal_collate_fn."""

    def test_basic_collation(self):
        """Test basic batch collation."""
        batch = [make_sample() for _ in range(4)]

        result = omni_modal_collate_fn(batch, modality_names=["vision"])
    ...
    def test_multiple_modalities(self):
        ...
        result = omni_modal_collate_fn(batch, modality_names=["vision", "audio"])
    ...
    def test_empty_batch(self):
        ...
        result = omni_modal_collate_fn([], modality_names=["vision"])
        assert result == {}
