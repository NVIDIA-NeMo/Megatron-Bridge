#!/bin/bash
# Usage:
#   Deterministic with Flash Attention on GB200: bash run_llama3_70b_nan_loss_deterministic.sh
set -euo pipefail
source ../../secrets.sh
...
export BACKEND=flash  # Allow Flash Attention in deterministic mode
