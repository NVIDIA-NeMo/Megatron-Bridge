...
#   Deterministic mode: DETERMINISTIC=true ./run_llama3_8b_fp8.sh
#   Deterministic with Flash Attention: DETERMINISTIC=true DETERMINISTIC_FLASH=true ./run_llama3_8b_fp8.sh
set -euo pipefail
...
python scripts/performance/setup_experiment.py \
    ...
    -wdj "llama3-8b-fp8-nemo-25.11-${DETERMINISTIC_FLAG}" \
    --task pretrain \
