...
| [Gemma 2](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/gemma) | ✅ | ✅ ([2B/9B/27B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/gemma/gemma2.py)) | ✅ ([2B/9B/27B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/gemma/gemma2.py)) |
...
| [GLM-4.5V](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/glm_vl) | ✅ | Coming soon | ✅ ([106B-Air/355B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/glm_vl/glm_45v.py)) |
...
| [Kimi-K2](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/kimi) | ✅ | ✅ ([K2](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/kimi/kimi_k2.py)) | Coming soon |
...
| [MiniMax-M2](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/minimax_m2) | ✅ | Coming soon | Coming soon |
| [MiMo](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/mimo) | ✅ | Coming soon | Coming soon |
...
| [Nemotron-3 Nano](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/nemotronh) | ✅ | ✅ ([30B-A3B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/nemotronh/nemotron_3_nano.py)) | ✅ ([30B-A3B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/nemotronh/nemotron_3_nano.py)) |
...
| [Nemotron-H](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/nemotronh) | ✅ | ✅ ([4B/8B/47B/56B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/nemotronh/nemotronh.py)) | ✅ ([4B/8B/47B/56B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/nemotronh/nemotronh.py)) |
| [Nemotron Nano v2](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/nemotronh) | ✅ | ✅ ([9B/12B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/nemotronh/nemotron_nano_v2.py)) | ✅ ([9B/12B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/nemotronh/nemotron_nano_v2.py)) |
...
| [Qwen2-Audio](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/qwen_audio) | ✅ | Coming soon | Coming soon |
...
| [Qwen2.5-Omni](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/qwen_omni) | ✅ | Coming soon | Coming soon |
...
| [Qwen3-MoE](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/qwen) | ✅ | ✅ ([30B-A3B/235B-A22B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/qwen/qwen3_moe.py)) | ✅ ([30B-A3B/235B-A22B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/qwen/qwen3_moe.py)) |
...
| [Qwen3-VL](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/qwen_vl) | ✅ | Coming soon | ✅ ([8B/30B-A3B/235B-A22B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/qwen_vl/qwen3_vl.py)) |
| [Qwen3.5-VL](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/qwen_vl) | ✅ | Coming soon | ✅ ([800M/2B/4B/9B/27B/35B-A3B/122B-A10B/397B-A17B](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/recipes/qwen_vl/qwen35_vl.py)) |
| [Sarvam](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/sarvam) | ✅ | Coming soon | Coming soon |

### Model Examples

The [`examples/models/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models) directory provides **verified, production-ready scripts** for each supported model family. Each subdirectory contains ready-to-run shell scripts for checkpoint conversion, inference, SFT, LoRA/PEFT, and pretraining. These scripts are validated through CI and serve as the canonical starting point when working with a new model.

#### Large Language Models

| Model | Directory | Scripts |
|-------|-----------|---------|
| GPT-OSS (20B/120B) | [`gpt_oss/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/gpt_oss) | Conversion · Inference · Pretrain · SFT · PEFT |
| MiniMax-M2 (456B MoE) | [`minimax_m2/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/minimax_m2) | Conversion · Inference |
| Nemotron-3 Nano (30B-A3B) | [`nemotron_3/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/nemotron_3) | Conversion · Pretrain · SFT · PEFT |
| Qwen3-Next (80B-A3B) | [`qwen3_next/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/qwen3_next) | Finetune |
| Sarvam (30B MoE) | [`sarvam/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/sarvam) | Conversion · Inference |

#### Vision Language Models

| Model | Directory | Scripts |
|-------|-----------|---------|
| Gemma3-VL (4B/12B/27B) | [`vlm/gemma3_vl/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/vlm/gemma3_vl) | Conversion · Inference · SFT · PEFT |
| GLM-4.5V (106B-Air/355B) | [`vlm/glm_45v/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/vlm/glm_45v) | Conversion · Inference · SFT · PEFT |
| Ministral3 VL | [`vlm/ministral3/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/vlm/ministral3) | Conversion · Inference · SFT · PEFT |
| Nemotron Nano v2 VL (9B/12B) | [`vlm/nemotron_vl/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/vlm/nemotron_vl) | Finetune |
| Qwen2.5-Omni | [`vlm/qwen25_omni/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/vlm/qwen25_omni) | Conversion · Inference |
| Qwen2.5-VL (3B/7B/32B/72B) | [`vlm/qwen_vl/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/vlm/qwen_vl) | Finetune |
| Qwen3-VL (8B/30B-A3B/235B-A22B) | [`vlm/qwen3_vl/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/vlm/qwen3_vl) | Conversion · Inference · SFT · PEFT |
| Qwen3.5-VL | [`vlm/qwen35_vl/`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/vlm/qwen35_vl) | Conversion · Inference · SFT · PEFT |
