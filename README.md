...
# 2) Get a builder-backed config and configure parallelism before instantiation
...
if __name__ == "__main__":
    ...
    # cfg.model = AutoBridge.from_hf_pretrained("/path/to/local/hf_model").get_model_config()
...
random-init pretraining from an HF architecture, where `AutoBridge.from_hf_pretrained(...).get_model_config()`
