...
from megatron_hub.training.eval import evaluate_and_print_results
from megatron_hub.training.initialize import destroy_global_state
from megatron_hub.training.state import GlobalState
from megatron_hub.utils import flop_utils
from megatron_hub.utils.async_utils import maybe_finalize_async_save
from megatron_hub.utils.common_utils import get_world_size_safe, print_rank_0
from megatron_hub.utils.log_utils import append_to_progress_log, barrier_and_log
from megatron_hub.utils.train_utils import (
    calc_params_l2_norm,
