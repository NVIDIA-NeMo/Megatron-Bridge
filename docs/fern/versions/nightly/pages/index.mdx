...
<div className="readme-badge-row">
  <a href="https://codecov.io/github/NVIDIA-NeMo/Megatron-Bridge" target="_blank" rel="noreferrer"><img src="https://codecov.io/github/NVIDIA-NeMo/Megatron-Bridge/graph/badge.svg?token=4NMKZVOW2Z" alt="codecov" /></a>
  <a href="https://github.com/NVIDIA-NeMo/Megatron-Bridge/actions/workflows/cicd-main.yml" target="_blank" rel="noreferrer"><img src="https://github.com/NVIDIA-NeMo/Megatron-Bridge/actions/workflows/cicd-main.yml/badge.svg" alt="CICD NeMo" /></a>
  <a href="https://www.python.org/downloads/release/python-3100/" target="_blank" rel="noreferrer"><img src="https://img.shields.io/badge/python-3.10+-blue.svg" alt="Python 3.10+" /></a>
  <a href="https://github.com/NVIDIA-NeMo/Megatron-Bridge/stargazers/" target="_blank" rel="noreferrer"><img src="https://img.shields.io/github/stars/NVIDIA-NeMo/Megatron-Bridge.svg?style=social&label=Star&cacheSeconds=14400" alt="GitHub Stars" /></a>
</div>
