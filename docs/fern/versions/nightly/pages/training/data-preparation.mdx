...
| Multimodal SFT or PEFT | Recommended | Hosted Hugging Face rows or local conversation JSON/JSONL | [Multimodal Direct-HF](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/tutorials/data/multimodal-direct/README.md) through `DirectHFSFTDatasetConfig` + builder |
...
For complete preparation and Qwen3-VL launch commands, see the [multimodal Energon tutorial](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/tutorials/data/energon/README.md). [VALOR32K-AVQA](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/tutorials/data/valor32k-avqa/data-preparation.md) is the larger audio-video example.
