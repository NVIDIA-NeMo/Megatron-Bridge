...
[parallelism strategies skill](skills/mbridge-perf-parallelism-strategies/SKILL.md).
...
- **Operational skill**: [skills/mbridge-perf-parallelism-strategies/SKILL.md](skills/mbridge-perf-parallelism-strategies/SKILL.md) — enablement, pitfalls, memory estimation, verification
- **Knowledge card**: [skills/mbridge-perf-parallelism-strategies/card.yaml](skills/mbridge-perf-parallelism-strategies/card.yaml) — structured metadata and validation status
