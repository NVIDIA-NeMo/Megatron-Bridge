...
- [skills/mbridge-perf-activation-recompute/SKILL.md](../skills/mbridge-perf-activation-recompute/SKILL.md) — per-module cost/savings data, measured results
- [skills/mbridge-perf-memory-tuning/SKILL.md](../skills/mbridge-perf-memory-tuning/SKILL.md) — expandable segments, parallelism resizing, and other memory reduction strategies
