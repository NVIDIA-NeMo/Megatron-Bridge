...
parameter tables, code anchors, and verification commands, see [skills/mbridge-resiliency/SKILL.md](../skills/mbridge-resiliency/SKILL.md).
...
- Requires compatible checkpoint format (see [skills/mbridge-resiliency/SKILL.md](../skills/mbridge-resiliency/SKILL.md))
...
- [skills/mbridge-resiliency/SKILL.md](../skills/mbridge-resiliency/SKILL.md)
- [skills/mbridge-resiliency/card.yaml](../skills/mbridge-resiliency/card.yaml)
- [NVIDIA Resiliency Extension](https://github.com/NVIDIA/nvidia-resiliency-ext)
