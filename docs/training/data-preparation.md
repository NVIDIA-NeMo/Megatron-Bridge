...
For Hub and file-backed Hugging Face datasets, text and multimodal schemas, split sources, in-batch packing, processor selection, and all available knobs, see the [direct SFT dataset tutorial](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/tutorials/data/direct-hf-sft/README.md).
