...
[skills/nemo-mbridge-perf-cuda-graphs/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-cuda-graphs/SKILL.md).
...
- [Performance Guide](/training/performance-tuning)
- [Communication Overlap](/training/communication-overlap)
- [skills/nemo-mbridge-perf-cuda-graphs/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-cuda-graphs/SKILL.md)
