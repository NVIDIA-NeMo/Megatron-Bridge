...
| **[Dynamic Context Parallel](dynamic-context-parallel.md)** | Online sequence packing with per-bin context-parallel groups | Variable-length long-context training |
