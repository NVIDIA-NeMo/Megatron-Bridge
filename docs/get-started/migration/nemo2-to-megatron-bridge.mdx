...
For details on using and customizing recipes, see [recipe usage](/training/recipe-usage).
...
See [bridge guide](/get-started/quickstart/hugging-face-conversion) for more details on model conversion.
...
For complete details on launching training jobs, configuration overrides, and NeMo-Run integration, see [recipe usage](/training/recipe-usage).
