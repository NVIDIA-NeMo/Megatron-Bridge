...
- Mapping used for MXFP8 precision could not fit for  NVFP4 precision for this model.
- We expect to achieve better performance for NVFP4 precision in future when NVFP4 param gather is supported.
