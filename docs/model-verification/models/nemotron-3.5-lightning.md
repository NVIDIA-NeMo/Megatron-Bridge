...
| Field | Value |
| --- | --- |
| Card | [`examples/model_verification_cards/nemotron-3.5-lightning/card.yaml`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/examples/model_verification_cards/nemotron-3.5-lightning/card.yaml) |
| Hugging Face model | [`nvidia/NVIDIA-Nemotron-3.5-Lightning-30B-A3B-BF16`](https://huggingface.co/nvidia/NVIDIA-Nemotron-3.5-Lightning-30B-A3B-BF16) |
| Hugging Face revision | `b3caaabed0263651a17dc1f2d4ce97e794f76c44` |
| Architecture | `NemotronHForCausalLM` |
| Minimum Transformers | `5.8.1` |
| Base container | `nvcr.io/nvidia/nemo:26.08` |
| Card-level Bridge commit | `619a2df1da9517b4408ea475b428bf2aba618c8f` |
| Complementary model documentation | [Open model guide](../../models/README.md) |
| Aggregate state | **verified** |

Concrete status counts: ✅ verified: **22**, ⚪ unverified: **0**, ❌ unsupported: **0**, ➖ not applicable: **0**.
...
<a id="nemotron-3-5-lightning-hf-to-megatron-cpu"></a>
### hf_to_megatron_cpu
...
| Effective Bridge commit | `7edd7c7f68bcdd2b30cbaff426ece2ee0da9deb5` |
...
<a id="nemotron-3-5-lightning-hf-to-megatron-gpu"></a>
### hf_to_megatron_gpu
...
| Precision | `bf16` |
| Last verified | `2026-07-23` |
| Effective Bridge commit | `619a2df1da9517b4408ea475b428bf2aba618c8f` |
...
<a id="nemotron-3-5-lightning-megatron-to-hf-cpu"></a>
### megatron_to_hf_cpu
...
<a id="nemotron-3-5-lightning-megatron-to-hf-gpu"></a>
### megatron_to_hf_gpu
...
<a id="nemotron-3-5-lightning-manual-forward-pass"></a>
### manual_forward_pass
...
The pinned-revision one-step comparison exits successfully. Hugging Face and Megatron next-token predictions match at token ID 6993 (" Paris"); cosine similarity is 0.998581, above the 0.99 gate. Maximum and mean absolute logit differences are 0.796875 and 0.116128, respectively.

<a id="nemotron-3-5-lightning-inference"></a>
### inference
...
Two independent runs produce byte-identical output with this exact 2-token completion, including its leading space: " Paris.".

<a id="nemotron-3-5-lightning-pretrain-h100"></a>
### pretrain · H100
...
| Effective Bridge commit | `33ede31740aa44183a253a62a4bcf968f176e161` |

#### Explicit command topology

| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=8, sequence_length=8192, recipe=nemotron_3_5_lightning_pretrain_config, total_gpus=16` |
...
| `cuda_graph` | `{"implementation": "transformer_engine", "scopes": ["mamba"]}` |
...
<a id="nemotron-3-5-lightning-pretrain-gb200"></a>
### pretrain · GB200
...
| Precision | `bf16` |
| Last verified | `2026-07-28` |
| Effective Bridge commit | `edca4a7d868cd1214bf5292f28a515139470dd99` |

#### Explicit command topology

| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=4, sequence_length=8192, recipe=nemotron_3_5_lightning_pretrain_8k_config, total_gpus=8` |
...
<a id="nemotron-3-5-lightning-pretrain-fsdp-gb200-bf16"></a>
### pretrain_fsdp · GB200 · bf16

| Field | Value |
| --- | --- |
| Status | **✅ verified** |
| Source pointer | `items.pretrain_fsdp.GB200.variants.bf16` |
| Hardware | `GB200` |
| Precision | `bf16` |
| Last verified | `2026-07-28` |
| Effective Bridge commit | `edca4a7d868cd1214bf5292f28a515139470dd99` |
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=4, sequence_length=8192, recipe=nemotron_3_5_lightning_pretrain_8k_fsdp_config, total_gpus=8` |
...
<a id="nemotron-3-5-lightning-pretrain-fsdp-gb200-fp8-mx"></a>
### pretrain_fsdp · GB200 · fp8_mx

| Field | Value |
| --- | --- |
| Status | **✅ verified** |
| Source pointer | `items.pretrain_fsdp.GB200.variants.fp8_mx` |
| Hardware | `GB200` |
| Precision | `fp8_mx` |
| Last verified | `2026-07-24` |
| Effective Bridge commit | `968ab25dd0e8b76801e757ee9976d9806af9c11a` |

#### Explicit command topology

| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=4, recipe=nemotron_3_5_lightning_pretrain_8gpu_gb200_fp8mx_fsdp_config, total_gpus=8` |
...
<a id="nemotron-3-5-lightning-sft-h100"></a>
### sft · H100
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=8, recipe=nemotron_3_5_lightning_sft_openmathinstruct2_packed_config, total_gpus=16` |
...
<a id="nemotron-3-5-lightning-sft-gb200"></a>
### sft · GB200
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=4, recipe=nemotron_3_5_lightning_sft_openmathinstruct2_packed_tp1_config, total_gpus=8` |
...
<a id="nemotron-3-5-lightning-sft-export-inference-h100"></a>
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=8, tensor_parallel=2, pipeline_parallel=1, expert_parallel=8, expert_tensor_parallel=1, total_gpus=16` |
| 2 | `not specified` |
...
The step-100 SFT checkpoint exports 6,513 tensors, including all 270 MTP tensors, to native Hugging Face format and reloads as NemotronHForCausalLM. The deterministic verifier performs one greedy generation and produces exactly 45 new tokens. The literal completion is: "To solve for $x$, follow these steps:

1. Subtract 5 from both sides of the equation:
\[ 3x + 5 - 5 = 20 - 5 \Rightarrow 3x".

<a id="nemotron-3-5-lightning-sft-export-inference-gb200"></a>
...
<a id="nemotron-3-5-lightning-sft-long-context-h100"></a>
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=8, tensor_parallel=2, context_parallel=2, expert_parallel=8, expert_tensor_parallel=1, sequence_length=32768, recipe=nemotron_3_5_lightning_sft_config, total_gpus=16` |
...
<a id="nemotron-3-5-lightning-sft-long-context-gb200"></a>
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=4, context_parallel=2, expert_parallel=8, expert_tensor_parallel=1, sequence_length=32768, recipe=nemotron_3_5_lightning_sft_config, total_gpus=8` |
...
<a id="nemotron-3-5-lightning-peft-h100"></a>
### peft · H100
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=1, gpus_per_node=8, tensor_parallel=2, expert_parallel=8, expert_tensor_parallel=1, sequence_length=4096, recipe=nemotron_3_5_lightning_peft_config, total_gpus=8` |
...
<a id="nemotron-3-5-lightning-peft-gb200"></a>
### peft · GB200
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=4, tensor_parallel=2, expert_parallel=8, expert_tensor_parallel=1, sequence_length=4096, recipe=nemotron_3_5_lightning_peft_config, total_gpus=8` |
...
<a id="nemotron-3-5-lightning-checkpoint-resume-h100"></a>
...
<a id="nemotron-3-5-lightning-checkpoint-resume-gb200"></a>
...
<a id="nemotron-3-5-lightning-pretrain-performance-h100"></a>
...
| Precision | `bf16` |
| Last verified | `2026-08-03` |
| Effective Bridge commit | `573e088c9c6740082c39744e03dc5b009e730ed4` |

#### Explicit command topology

| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=8, recipe=nemotron_3_5_lightning_pretrain_16gpu_h100_bf16_config, total_gpus=16` |
...
<a id="nemotron-3-5-lightning-pretrain-performance-gb200"></a>
...
| Precision | `bf16` |
| Last verified | `2026-07-28` |
| Effective Bridge commit | `9b0c2dff42e6175e91d34cd2a504529f803ebde9` |

#### Explicit command topology

| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=4, recipe=nemotron_3_5_lightning_pretrain_8gpu_gb200_bf16_config, total_gpus=8` |
