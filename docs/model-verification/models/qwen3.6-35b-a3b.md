...
| Field | Value |
| --- | --- |
| Card | [`examples/model_verification_cards/qwen3.6-35b-a3b/card.yaml`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/examples/model_verification_cards/qwen3.6-35b-a3b/card.yaml) |
| Hugging Face model | [`Qwen/Qwen3.6-35B-A3B`](https://huggingface.co/Qwen/Qwen3.6-35B-A3B) |
| Hugging Face revision | `995ad96eacd98c81ed38be0c5b274b04031597b0` |
| Architecture | `Qwen3_5MoeForConditionalGeneration` |
| Minimum Transformers | `5.8.1` |
| Base container | `nvcr.io/nvidia/nemo:26.06` |
| Card-level Bridge commit | `5db2290dea4887a2ca9072c0d554707bf272945d` |
| Complementary model documentation | [Open model guide](../../models/qwen/qwen35-vl.md) |
| Aggregate state | **verified** |

Concrete status counts: ✅ verified: **16**, ⚪ unverified: **0**, ❌ unsupported: **0**, ➖ not applicable: **0**.
...
<a id="qwen3-6-35b-a3b-hf-to-megatron-cpu"></a>
### hf_to_megatron_cpu
...
| Effective Bridge commit | `58b11d7e122b6d7da57d1b5f264fe7fa61e393ec` |
...
<a id="qwen3-6-35b-a3b-hf-to-megatron-gpu"></a>
### hf_to_megatron_gpu
...
| Precision | `bf16` |
| Last verified | `2026-07-23` |
| Effective Bridge commit | `5db2290dea4887a2ca9072c0d554707bf272945d` |

#### Explicit command topology

| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=8, tensor_parallel=2, expert_parallel=8, total_gpus=16` |
...
<a id="qwen3-6-35b-a3b-megatron-to-hf-cpu"></a>
### megatron_to_hf_cpu
...
| Precision | `bf16` |
| Last verified | `2026-07-23` |
| Effective Bridge commit | `72d554863cd4dbcacd26abda92054afd0506e668` |
...
<a id="qwen3-6-35b-a3b-megatron-to-hf-gpu"></a>
### megatron_to_hf_gpu
...
<a id="qwen3-6-35b-a3b-manual-forward-pass"></a>
### manual_forward_pass
...
| Precision | `bf16` |
| Last verified | `2026-07-23` |
| Effective Bridge commit | `ac39e582036c4f120257735bf22d71b8d7a1cddb` |

#### Explicit command topology

| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=1, gpus_per_node=8, pipeline_parallel=8, total_gpus=8` |
...
| Effective Bridge commit | `52601b0382f869c9ca14109acdcdef77cc4fa61a` |

#### Explicit command topology

| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=1, gpus_per_node=8, recipe=qwen35_vl_35b_a3b_pretrain_mock_config, total_gpus=8` |
...
<a id="qwen3-6-35b-a3b-sft-h100"></a>
### sft · H100
...
| Effective Bridge commit | `7f9b59730d17a255d46ff02e3795546f0284f748` |

#### Explicit command topology

| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=8, recipe=qwen35_vl_35b_a3b_sft_16gpu_h100_bf16_config, total_gpus=16` |
...
<a id="qwen3-6-35b-a3b-sft-gb200"></a>
### sft · GB200
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=4, recipe=qwen35_vl_35b_a3b_sft_8gpu_gb200_bf16_functional_config, total_gpus=8` |
...
<a id="qwen3-6-35b-a3b-sft-export-inference-h100"></a>
...
| Precision | `bf16` |
| Last verified | `2026-07-28` |
| Effective Bridge commit | `5ca8f9fb536808d49477b58b33538f5f6629ed3f` |

#### Explicit command topology

| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=4, gpus_per_node=8, recipe=qwen35_vl_35b_a3b_sft_long_context_32gpu_h100_bf16_config, total_gpus=32` |
...
<a id="qwen3-6-35b-a3b-peft-h100"></a>
### peft · H100
...
| Precision | `bf16` |
| Last verified | `2026-08-05` |
| Effective Bridge commit | `19b2647fe9495dd1497e0400a760abf8ca541309` |

#### Explicit command topology

| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=8, recipe=qwen35_vl_35b_a3b_peft_16gpu_h100_bf16_config, total_gpus=16` |
...
| Field | Value |
| --- | --- |
| `cuda_graph` | `{"implementation": "transformer_engine", "scopes": ["attn", "mlp", "moe_router", "moe_preprocess"]}` |
| `moe_dispatcher` | `hybridep` |
...
<a id="qwen3-6-35b-a3b-peft-gb200"></a>
### peft · GB200
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=4, recipe=qwen35_vl_35b_a3b_peft_8gpu_gb200_bf16_functional_config, total_gpus=8` |
...
<a id="qwen3-6-35b-a3b-checkpoint-resume-h100"></a>
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=8, recipe=qwen35_vl_35b_a3b_pretrain_16gpu_h100_bf16_functional_config, total_gpus=16` |
...
<a id="qwen3-6-35b-a3b-pretrain-performance-gb200"></a>
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=4, recipe=qwen35_vl_35b_a3b_pretrain_8gpu_gb200_fp8mx_config, total_gpus=8` |
