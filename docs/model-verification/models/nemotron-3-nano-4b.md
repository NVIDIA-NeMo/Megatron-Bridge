...
Performance disclaimer: this model has not been performance-tuned; reported timing and throughput metrics are sanity checks, not optimized performance results. Nemotron 3 Nano 4B support verification covers conversion, inference, and training.
...
| Field | Value |
| --- | --- |
| Card | [`examples/model_verification_cards/nemotron-3-nano-4b/card.yaml`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/examples/model_verification_cards/nemotron-3-nano-4b/card.yaml) |
| Hugging Face model | [`nvidia/NVIDIA-Nemotron-3-Nano-4B-BF16`](https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Nano-4B-BF16) |
| Hugging Face revision | `dfaf35de3e30f1867dd8dbc38a7fc9fb52d3914f` |
| Architecture | `NemotronHForCausalLM` |
| Minimum Transformers | `5.8.1` |
| Base container | `nvcr.io/nvidia/pytorch:26.04-py3` |
| Card-level Bridge commit | `0e6c1837edeb442b07c9175b855b3d288c5cad33` |
...
<a id="nemotron-3-nano-4b-hf-to-megatron-cpu"></a>
### hf_to_megatron_cpu
...
| Effective Bridge commit | `0e6c1837edeb442b07c9175b855b3d288c5cad33` |
...
<a id="nemotron-3-nano-4b-hf-to-megatron-gpu"></a>
### hf_to_megatron_gpu
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=1, gpus_per_node=1, tensor_parallel=1, total_gpus=1` |
...
<a id="nemotron-3-nano-4b-megatron-to-hf-cpu"></a>
### megatron_to_hf_cpu
...
<a id="nemotron-3-nano-4b-megatron-to-hf-gpu"></a>
### megatron_to_hf_gpu
...
<a id="nemotron-3-nano-4b-manual-forward-pass"></a>
### manual_forward_pass
...
The eight-token one-step comparison exits successfully using native Transformers Nemotron-H and a real Megatron inference context. Both paths have next-token predictions that match at token ID 6993 (" Paris"); cosine similarity is 0.999982 and the maximum and mean absolute logit differences are 0.093750 and 0.018522.

<a id="nemotron-3-nano-4b-inference"></a>
### inference
...
| Precision | `bf16` |
| Last verified | `2026-07-20` |
| Effective Bridge commit | `78ecfad7644ee67efa4e8af4b0e7cf09f6bc9ecc` |
...
Two independent runs use greedy decoding, produce byte-identical token IDs, and return exactly 2 generated tokens with this literal completion, including its leading space: ' Paris."'.

<a id="nemotron-3-nano-4b-pretrain-h100"></a>
### pretrain · H100
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=1, gpus_per_node=8, sequence_length=4096, recipe=nemotron_3_nano_4b_pretrain_8gpu_h100_bf16_config, total_gpus=8` |
...
<a id="nemotron-3-nano-4b-sft-h100"></a>
### sft · H100
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=1, gpus_per_node=8, sequence_length=2048, recipe=nemotron_3_nano_4b_sft_8gpu_h100_bf16_config, total_gpus=8` |
...
<a id="nemotron-3-nano-4b-sft-export-inference-h100"></a>
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=1, gpus_per_node=8, tensor_parallel=2, context_parallel=2, sequence_length=32768, recipe=nemotron_3_nano_4b_sft_8gpu_h100_bf16_32k_config, total_gpus=8` |
...
<a id="nemotron-3-nano-4b-peft-h100"></a>
### peft · H100
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=1, gpus_per_node=8, sequence_length=2048, recipe=nemotron_3_nano_4b_peft_8gpu_h100_bf16_config, total_gpus=8` |
...
<a id="nemotron-3-nano-4b-checkpoint-resume-h100"></a>
