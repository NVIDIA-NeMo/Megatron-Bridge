...
Performance disclaimer: this model has not been performance-tuned; reported timing and throughput metrics are sanity checks, not optimized performance results. GPT-OSS 20B H100 support verification has completed GPU HF-to-Megatron conversion, GPU Megatron-to-HF export, manual forward-pass correlation, deterministic Megatron inference, bounded pretraining, full SFT, SFT export/inference, long-context SFT, LoRA PEFT, and direct checkpoint resume; CPU conversion remains pending.
...
| Field | Value |
| --- | --- |
| Card | [`examples/model_verification_cards/gpt-oss-20b/card.yaml`](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/examples/model_verification_cards/gpt-oss-20b/card.yaml) |
| Hugging Face model | [`openai/gpt-oss-20b`](https://huggingface.co/openai/gpt-oss-20b) |
| Hugging Face revision | `6cee5e81ee83917806bbde320786a8fb61efebee` |
| Architecture | `GptOssForCausalLM` |
| Minimum Transformers | `5.8.0` |
| Base container | `nvcr.io/nvidia/nemo:26.06` |
| Card-level Bridge commit | `6799f099712c961f15cf92d6bd88998f029d672d` |
| Complementary model documentation | [Open model guide](../../models/gpt_oss/gpt-oss.md) |
| Aggregate state | **partially verified** |

Concrete status counts: ✅ verified: **10**, ⚪ unverified: **2**, ❌ unsupported: **0**, ➖ not applicable: **0**.
...
<a id="gpt-oss-20b-hf-to-megatron-cpu"></a>
### hf_to_megatron_cpu
...
| Precision | `bf16` |
| Last verified | `—` |
| Effective Bridge commit | `6799f099712c961f15cf92d6bd88998f029d672d` |
...
<a id="gpt-oss-20b-hf-to-megatron-gpu"></a>
### hf_to_megatron_gpu
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=1, gpus_per_node=8, tensor_parallel=2, pipeline_parallel=2, expert_parallel=2, expert_tensor_parallel=1, total_gpus=8` |
...
<a id="gpt-oss-20b-megatron-to-hf-cpu"></a>
### megatron_to_hf_cpu
...
```bash
./scripts/conversion/convert.sh export --executor slurm --device cpu --nodes 1 --hf-model unsloth/gpt-oss-20b-BF16 --megatron-path work/model-verification/gpt-oss-20b/cpu-megatron/iter_0000000 --hf-path work/model-verification/gpt-oss-20b/cpu-hf-export --torch-dtype bfloat16 --trust-remote-code
```

#### Expected result

Future verification must export the CPU-imported Megatron checkpoint to the public unquantized BF16 Hugging Face layout and verify that Transformers reloads the result as GptOssForCausalLM with no missing, unexpected, shape, dtype, or value mismatches against the BF16 reference semantics.

<a id="gpt-oss-20b-megatron-to-hf-gpu"></a>
### megatron_to_hf_gpu
...
<a id="gpt-oss-20b-manual-forward-pass"></a>
### manual_forward_pass
...
| Command | Explicit topology |
| --- | --- |
| 1 | `tensor_parallel=2, pipeline_parallel=2, expert_parallel=2, expert_tensor_parallel=1` |
...
The command exits successfully after exactly 32 new tokens and prints this
...
<a id="gpt-oss-20b-pretrain-h100"></a>
### pretrain · H100
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=2, gpus_per_node=8, sequence_length=4096, recipe=gpt_oss_20b_pretrain_16gpu_h100_bf16_config, total_gpus=16` |
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=1, gpus_per_node=8, sequence_length=2048, recipe=gpt_oss_20b_sft_8gpu_h100_bf16_config, total_gpus=8` |
...
<a id="gpt-oss-20b-sft-export-inference-h100"></a>
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=1, gpus_per_node=8, tensor_parallel=4, context_parallel=2, sequence_length=32768, recipe=gpt_oss_20b_sft_8gpu_h100_bf16_32k_config, total_gpus=8` |
...
| Command | Explicit topology |
| --- | --- |
| 1 | `nodes=1, gpus_per_node=1, sequence_length=2048, recipe=gpt_oss_20b_peft_1gpu_h100_bf16_config, total_gpus=1` |
...
<a id="gpt-oss-20b-checkpoint-resume-h100"></a>
