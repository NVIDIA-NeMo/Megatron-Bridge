...
For Megatron-LM checkpoints with saved arguments, see
[Export an existing Megatron-LM checkpoint](megatron-lm-to-megatron-bridge.md#export-an-existing-megatron-lm-checkpoint).
