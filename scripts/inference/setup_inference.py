...
INFERENCE_TASKS = {
    ...
    "full-prefix-generation": Path("examples/conversion/hf_to_megatron_generate_text.py"),
...
for a one-step Hugging Face/Megatron comparison. Use --task
full-prefix-generation with --legacy-full-prefix for models that do not yet
support cached inference. Arguments not owned by this launcher are forwarded
