...
from .llama2_workload_base_configs import (
...
from .llama3_workload_base_configs import (
    ...
    LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_CS_MLPERF_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_CS_MLPERF_V2,
    LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_CS_MLPERF_V3,
    LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_MX_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_MX_MLPERF_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_MX_MLPERF_V2,
    LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_MX_MLPERF_V3,
    LLAMA3_8B_PRETRAIN_CONFIG_GB200_NVFP4_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V2,
    LLAMA3_8B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V3,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_BF16_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_CS_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_CS_MLPERF_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_CS_MLPERF_V2,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_CS_MLPERF_V3,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_MX_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_MX_MLPERF_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_MX_MLPERF_V2,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_MX_MLPERF_V3,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_NVFP4_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_NVFP4_MLPERF_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_NVFP4_MLPERF_V2,
    LLAMA3_8B_PRETRAIN_CONFIG_GB300_NVFP4_MLPERF_V3,
    LLAMA3_8B_PRETRAIN_CONFIG_B300_FP8_CS_MLPERF_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_B300_FP8_MX_MLPERF_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_B300_NVFP4_MLPERF_V1,
    LLAMA3_8B_PRETRAIN_CONFIG_B300_FP8_CS_MLPERF_V2,
    LLAMA3_8B_PRETRAIN_CONFIG_B300_FP8_MX_MLPERF_V2,
    LLAMA3_8B_PRETRAIN_CONFIG_B300_NVFP4_MLPERF_V2,
    LLAMA3_8B_PRETRAIN_CONFIG_B300_FP8_CS_MLPERF_V3,
    LLAMA3_8B_PRETRAIN_CONFIG_B300_FP8_MX_MLPERF_V3,
    LLAMA3_8B_PRETRAIN_CONFIG_B300_NVFP4_MLPERF_V3,
...
__all__ = [
    # Llama 2 70B LoRA V1 baseline (MLPerf v6.0 LoRA workload)
    "LLAMA2_70B_LORA_CONFIG_GB200_BF16_V1",
    "LLAMA2_70B_LORA_CONFIG_GB200_FP8_CS_V1",
    "LLAMA2_70B_LORA_CONFIG_GB200_NVFP4_V1",
    "LLAMA2_70B_LORA_CONFIG_GB300_BF16_V1",
    "LLAMA2_70B_LORA_CONFIG_GB300_FP8_CS_V1",
    "LLAMA2_70B_LORA_CONFIG_GB300_NVFP4_V1",
    # Llama 2 70B LoRA MLPERF V1/V2/V3 — MLPerf v6.0 reference parity, GB200/GB300 only
    "LLAMA2_70B_LORA_CONFIG_GB200_FP8_CS_MLPERF_V1",
    "LLAMA2_70B_LORA_CONFIG_GB200_FP8_CS_MLPERF_V2",
    "LLAMA2_70B_LORA_CONFIG_GB200_FP8_CS_MLPERF_V3",
    "LLAMA2_70B_LORA_CONFIG_GB200_NVFP4_MLPERF_V1",
    ...
    "LLAMA31_405B_PRETRAIN_CONFIG_B300_NVFP4_MLPERF_V1",
    "LLAMA31_405B_PRETRAIN_CONFIG_B300_NVFP4_MLPERF_V2",
    # 405B NVFP4 MLPERF v6.0 parity (GB200/GB300: 256 GPU -> V1, 512 GPU -> V2, GBS=896)
    "LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V1",
    "LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V2",
    "LLAMA31_405B_PRETRAIN_CONFIG_GB300_NVFP4_MLPERF_V1",
    "LLAMA31_405B_PRETRAIN_CONFIG_GB300_NVFP4_MLPERF_V2",
    ...
    "LLAMA3_8B_PRETRAIN_CONFIG_VR200_FP8_MX_V1",
    "LLAMA3_8B_PRETRAIN_CONFIG_VR200_NVFP4_V1",
    # 8B Pretrain MLPERF V1 (8 GPU; tp1 pp1 cp1 mbs2 gbs16) — MLPerf v6.0 reference parity, GB200/GB300 only
    "LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_CS_MLPERF_V1",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_MX_MLPERF_V1",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V1",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_CS_MLPERF_V1",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_MX_MLPERF_V1",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB300_NVFP4_MLPERF_V1",
    # 8B Pretrain MLPERF V2 (16-64 GPU mid shape; FP8 cp2 / NVFP4 cp1) — GB200/GB300 only
    "LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_CS_MLPERF_V2",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_MX_MLPERF_V2",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V2",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_CS_MLPERF_V2",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_MX_MLPERF_V2",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB300_NVFP4_MLPERF_V2",
    # 8B Pretrain MLPERF V3 (128 GPU sub shape; tp2 cp4 mbs1 gbs16) — GB200/GB300 only
    "LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_CS_MLPERF_V3",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_MX_MLPERF_V3",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V3",
    "LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_CS_MLPERF_V3",
...
if HAVE_MEGATRON_BRIDGE:
    __all__.extend(
        [
            # Llama 2 70B LoRA wrappers
            "llama2_70b_lora_config_gb200",
            "llama2_70b_lora_config_gb300",
            # Llama 3 / 3.1 wrappers
            "llama3_8b_pretrain_config_gb300",
            "llama3_8b_pretrain_config_gb200",
            "llama3_8b_pretrain_config_b300",
            "llama3_8b_pretrain_config_b200",
