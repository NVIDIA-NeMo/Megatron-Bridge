...
LLAMA3_70B_PRETRAIN_CONFIG_GB300_BF16_BASE_CONFIG = replace(
...
LLAMA3_70B_PRETRAIN_CONFIG_GB300_FP8_CS_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    micro_batch_size=2,
    use_megatron_fsdp=True,
...
LLAMA3_70B_PRETRAIN_CONFIG_GB300_FP8_MX_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    pipeline_model_parallel_size=4,
    virtual_pipeline_model_parallel_size=5,
)

LLAMA3_70B_PRETRAIN_CONFIG_GB300_NVFP4_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    pipeline_model_parallel_size=4,
    virtual_pipeline_model_parallel_size=5,
...
LLAMA3_70B_PRETRAIN_CONFIG_GB200_BF16_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    use_megatron_fsdp=True,
    cpu_offloading_num_layers=20,
)
...
LLAMA3_70B_PRETRAIN_CONFIG_GB200_FP8_CS_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    micro_batch_size=2,
    use_megatron_fsdp=True,
...
LLAMA3_70B_PRETRAIN_CONFIG_GB200_FP8_MX_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
...
LLAMA3_70B_PRETRAIN_CONFIG_GB200_NVFP4_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    pipeline_model_parallel_size=4,
    virtual_pipeline_model_parallel_size=5,
...
LLAMA3_70B_PRETRAIN_CONFIG_B200_BF16_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    tensor_model_parallel_size=2,
    pipeline_model_parallel_size=4,
    context_parallel_size=2,
...
LLAMA3_70B_PRETRAIN_CONFIG_B200_FP8_CS_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    use_megatron_fsdp=True,
...
LLAMA3_70B_PRETRAIN_CONFIG_B200_FP8_MX_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    tensor_model_parallel_size=2,
    pipeline_model_parallel_size=4,
    virtual_pipeline_model_parallel_size=5,
...
LLAMA3_70B_PRETRAIN_CONFIG_B200_NVFP4_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    context_parallel_size=2,
    pipeline_model_parallel_size=4,
    virtual_pipeline_model_parallel_size=5,
...
LLAMA3_70B_PRETRAIN_CONFIG_H100_BF16_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
...
LLAMA3_70B_PRETRAIN_CONFIG_H100_FP8_CS_BASE_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    tensor_model_parallel_size=4,
...
LLAMA3_8B_PRETRAIN_CONFIG_GB300_BF16_BASE_CONFIG = replace(
...
LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_CS_BASE_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=4,
    cuda_graph_impl="local",
    cuda_graph_scope="full_iteration",
...
LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_MX_BASE_CONFIG = LLAMA3_8B_PRETRAIN_CONFIG_GB300_FP8_CS_BASE_CONFIG

LLAMA3_8B_PRETRAIN_CONFIG_GB300_NVFP4_BASE_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=4,
    cuda_graph_impl="local",
    cuda_graph_scope="full_iteration",
...
LLAMA3_8B_PRETRAIN_CONFIG_GB200_BF16_BASE_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=2,
    cuda_graph_impl="local",
    cuda_graph_scope="full_iteration",
...
LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_CS_BASE_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=2,
    cuda_graph_impl="local",
    cuda_graph_scope="full_iteration",
...
LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_MX_BASE_CONFIG = LLAMA3_8B_PRETRAIN_CONFIG_GB200_FP8_CS_BASE_CONFIG

LLAMA3_8B_PRETRAIN_CONFIG_GB200_NVFP4_BASE_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=4,
    cuda_graph_impl="none",
    cuda_graph_scope="full_iteration",
...
LLAMA3_8B_PRETRAIN_CONFIG_B200_BF16_BASE_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=2,
    cuda_graph_impl="local",
    cuda_graph_scope="full_iteration",
...
LLAMA3_8B_PRETRAIN_CONFIG_B200_FP8_CS_BASE_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=2,
    cuda_graph_impl="local",
    cuda_graph_scope="full_iteration",
...
LLAMA3_8B_PRETRAIN_CONFIG_B200_FP8_MX_BASE_CONFIG = LLAMA3_8B_PRETRAIN_CONFIG_B200_FP8_CS_BASE_CONFIG

LLAMA3_8B_PRETRAIN_CONFIG_B200_NVFP4_BASE_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=4,
)


LLAMA3_8B_PRETRAIN_CONFIG_H100_BF16_BASE_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    context_parallel_size=2,
)


LLAMA3_8B_PRETRAIN_CONFIG_H100_FP8_CS_BASE_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
