...
LLAMA3_70B_SFT_CONFIG_GB300_FP8_CS_V1 = replace(  # 3% perf improvement
    _LLAMA3_70B_SFT_CONFIG_GB300,
...
LLAMA3_70B_SFT_CONFIG_GB200_FP8_MX_V1 = replace(  # 3% perf improvement
    _LLAMA3_70B_SFT_CONFIG_GB200,
    pipeline_model_parallel_size=2,
    virtual_pipeline_model_parallel_size=10,
)
