...
# MLPerf v6.0 reference parity (NVFP4 only). GBS=896 preserved across scales via halve-nodes + double-GA derivation.
# Recipe-level parity knobs applied by set_llama31_405b_mlperf_parity_overrides() in llama31_llm_pretrain.py.

# MLPERF_V1: 256 GPU (TP=4 PP=8 CP=2 VP=8 MBS=1 GBS=896, selective recompute on core_attn for memory fit)
LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V1 = replace(
    BASE_LLAMA31_405B_CONFIG,
    num_gpus=256,
    tensor_model_parallel_size=4,
    pipeline_model_parallel_size=8,
...
LLAMA31_405B_PRETRAIN_CONFIG_GB300_NVFP4_MLPERF_V1 = LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V1
LLAMA31_405B_PRETRAIN_CONFIG_B200_NVFP4_MLPERF_V1 = LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V1
LLAMA31_405B_PRETRAIN_CONFIG_B300_NVFP4_MLPERF_V1 = LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V1

# MLPERF_V2: 512 GPU (headline scale, GBS=896 canonical reference shape)
LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V2 = replace(
    LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V1,
    num_gpus=512,
)
LLAMA31_405B_PRETRAIN_CONFIG_GB300_NVFP4_MLPERF_V2 = LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V2
LLAMA31_405B_PRETRAIN_CONFIG_B200_NVFP4_MLPERF_V2 = LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V2
LLAMA31_405B_PRETRAIN_CONFIG_B300_NVFP4_MLPERF_V2 = LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V2
...
__all__ = [
    ...
    # MLPERF V1 (256 GPU canonical: TP=4 PP=8 CP=2 VP=8 MBS=1 GBS=896, NVFP4)
    "LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V1",
    "LLAMA31_405B_PRETRAIN_CONFIG_GB300_NVFP4_MLPERF_V1",
    "LLAMA31_405B_PRETRAIN_CONFIG_B200_NVFP4_MLPERF_V1",
    "LLAMA31_405B_PRETRAIN_CONFIG_B300_NVFP4_MLPERF_V1",
    # MLPERF V2 (512 GPU headline canonical: GBS=896, NVFP4)
    "LLAMA31_405B_PRETRAIN_CONFIG_GB200_NVFP4_MLPERF_V2",
    "LLAMA31_405B_PRETRAIN_CONFIG_GB300_NVFP4_MLPERF_V2",
    "LLAMA31_405B_PRETRAIN_CONFIG_B200_NVFP4_MLPERF_V2",
    "LLAMA31_405B_PRETRAIN_CONFIG_B300_NVFP4_MLPERF_V2",
]
