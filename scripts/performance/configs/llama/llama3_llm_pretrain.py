...
def llama3_70b_pretrain_config_gb300(precision: str = "bf16") -> ConfigContainer:
...
def llama3_70b_pretrain_config_gb200(precision: str = "bf16") -> ConfigContainer:
...
def llama3_70b_pretrain_config_b200(precision: str = "bf16") -> ConfigContainer:
...
def llama3_70b_pretrain_config_h100(precision: str = "bf16") -> ConfigContainer:
...
def llama3_8b_pretrain_config_gb300(precision: str = "bf16") -> ConfigContainer:
    """GB300, baseline config."""
    if precision == "bf16":
...
def llama3_8b_pretrain_config_gb200(precision: str = "bf16") -> ConfigContainer:
    """GB200, baseline config."""
    if precision == "bf16":
...
def llama3_8b_pretrain_config_b200(precision: str = "bf16") -> ConfigContainer:
    """B200, baseline config."""
    if precision == "bf16":
...
def llama3_8b_pretrain_config_h100(precision: str = "bf16") -> ConfigContainer:
    """H100, baseline config."""
    if precision == "bf16":
