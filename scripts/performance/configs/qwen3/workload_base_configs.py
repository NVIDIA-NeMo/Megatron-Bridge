...
QWEN3_235B_A22B_GB300_64GPUS_BF16_PARALLEL_CONFIG = replace(
...
QWEN3_235B_A22B_GB300_64GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_QWEN3_235B_A22B_CONFIG,
    tensor_model_parallel_size=2,
    expert_model_parallel_size=64,
    global_batch_size=1024,
...
QWEN3_235B_A22B_GB200_64GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_QWEN3_235B_A22B_CONFIG,
...
QWEN3_235B_A22B_GB200_64GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_QWEN3_235B_A22B_CONFIG,
    pipeline_model_parallel_size=8,
    expert_model_parallel_size=8,
    global_batch_size=1024,
...
QWEN3_235B_A22B_B200_64GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_QWEN3_235B_A22B_CONFIG,
    pipeline_model_parallel_size=8,
...
QWEN3_235B_A22B_B200_64GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_QWEN3_235B_A22B_CONFIG,
    pipeline_model_parallel_size=8,
    virtual_pipeline_model_parallel_size=2,
    expert_model_parallel_size=8,
...
QWEN3_235B_A22B_H100_256GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_QWEN3_235B_A22B_CONFIG,
    tensor_model_parallel_size=2,
    pipeline_model_parallel_size=8,
...
QWEN3_235B_A22B_H100_256GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_QWEN3_235B_A22B_CONFIG,
    tensor_model_parallel_size=2,
    pipeline_model_parallel_size=8,
    virtual_pipeline_model_parallel_size=4,
...
QWEN3_30B_A3B_GB300_8GPUS_BF16_PARALLEL_CONFIG = replace(
...
QWEN3_30B_A3B_GB300_8GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_QWEN3_30B_A3B_CONFIG,
    micro_batch_size=8,
    cuda_graph_impl="local",
    cuda_graph_scope=["full_iteration"],
...
QWEN3_30B_A3B_GB200_8GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_QWEN3_30B_A3B_CONFIG,
    micro_batch_size=4,
    cuda_graph_impl="local",
    cuda_graph_scope=["full_iteration"],
...
QWEN3_30B_A3B_GB200_8GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_QWEN3_30B_A3B_CONFIG,
    micro_batch_size=4,
    cuda_graph_impl="local",
    cuda_graph_scope=["full_iteration"],
...
QWEN3_30B_A3B_H100_16GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_QWEN3_30B_A3B_CONFIG,
...
QWEN3_30B_A3B_H100_16GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_QWEN3_30B_A3B_CONFIG,
    pipeline_model_parallel_size=2,
    virtual_pipeline_model_parallel_size=12,
    micro_batch_size=2,
