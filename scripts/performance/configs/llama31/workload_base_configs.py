...
LLAMA31_405B_GB300_128GPUS_BF16_PARALLEL_CONFIG = replace(
...
LLAMA31_405B_GB300_128GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_LLAMA31_405B_CONFIG,
    tensor_model_parallel_size=2,
    global_batch_size=64,
    use_megatron_fsdp=True,
...
LLAMA31_405B_GB300_128GPUS_FP8_MX_PARALLEL_CONFIG = replace(
    BASE_LLAMA31_405B_CONFIG,
...
LLAMA31_405B_GB200_128GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_LLAMA31_405B_CONFIG,
    tensor_model_parallel_size=4,
    pipeline_model_parallel_size=8,
    context_parallel_size=2,
...
LLAMA31_405B_GB200_128GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_LLAMA31_405B_CONFIG,
    tensor_model_parallel_size=2,
    global_batch_size=64,
    use_megatron_fsdp=True,
...
LLAMA31_405B_GB200_128GPUS_FP8_MX_PARALLEL_CONFIG = replace(
    BASE_LLAMA31_405B_CONFIG,
    tensor_model_parallel_size=4,
    pipeline_model_parallel_size=8,
    context_parallel_size=2,
...
LLAMA31_405B_B200_128GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_LLAMA31_405B_CONFIG,
    tensor_model_parallel_size=4,
    pipeline_model_parallel_size=8,
    context_parallel_size=2,
...
LLAMA31_405B_B200_128GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_LLAMA31_405B_CONFIG,
    tensor_model_parallel_size=4,
    pipeline_model_parallel_size=8,
    context_parallel_size=2,
...
LLAMA31_405B_H100_1024GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_LLAMA31_405B_CONFIG,
...
LLAMA31_405B_H100_1024GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_LLAMA31_405B_CONFIG,
    tensor_model_parallel_size=8,
    pipeline_model_parallel_size=8,
    context_parallel_size=2,
