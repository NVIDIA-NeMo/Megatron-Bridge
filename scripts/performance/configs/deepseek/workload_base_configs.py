...
DEEPSEEK_V3_GB300_256GPUS_BF16_PARALLEL_CONFIG = replace(
...
DEEPSEEK_V3_GB300_256GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_DEEPSEEK_V3_CONFIG,
    pipeline_model_parallel_size=4,
    virtual_pipeline_model_parallel_size=4,
    expert_model_parallel_size=64,
...
DEEPSEEK_V3_GB300_256GPUS_FP8_MX_PARALLEL_CONFIG = replace(
    BASE_DEEPSEEK_V3_CONFIG,
    pipeline_model_parallel_size=4,
    virtual_pipeline_model_parallel_size=4,
    expert_model_parallel_size=64,
...
DEEPSEEK_V3_GB200_256GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_DEEPSEEK_V3_CONFIG,
    pipeline_model_parallel_size=4,
    virtual_pipeline_model_parallel_size=4,
    expert_model_parallel_size=64,
...
DEEPSEEK_V3_GB200_256GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_DEEPSEEK_V3_CONFIG,
    pipeline_model_parallel_size=4,
    virtual_pipeline_model_parallel_size=4,
    expert_model_parallel_size=64,
...
DEEPSEEK_V3_GB200_256GPUS_FP8_MX_PARALLEL_CONFIG = replace(
    BASE_DEEPSEEK_V3_CONFIG,
    pipeline_model_parallel_size=4,
    virtual_pipeline_model_parallel_size=4,
    expert_model_parallel_size=64,
...
DEEPSEEK_V3_B200_256GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_DEEPSEEK_V3_CONFIG,
...
DEEPSEEK_V3_B200_256GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_DEEPSEEK_V3_CONFIG,
    pipeline_model_parallel_size=16,
    expert_model_parallel_size=8,
    global_batch_size=2048,
...
DEEPSEEK_V3_H100_1024GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_DEEPSEEK_V3_CONFIG,
...
DEEPSEEK_V3_H100_1024GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_DEEPSEEK_V3_CONFIG,
    tensor_model_parallel_size=2,
    pipeline_model_parallel_size=8,
    virtual_pipeline_model_parallel_size=4,
