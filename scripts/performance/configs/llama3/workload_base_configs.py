...
LLAMA3_70B_GB300_64GPUS_BF16_PARALLEL_CONFIG = replace(
...
LLAMA3_70B_GB300_64GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    micro_batch_size=2,
    use_megatron_fsdp=True,
...
LLAMA3_70B_GB300_64GPUS_FP8_MX_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
...
LLAMA3_70B_GB200_64GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    use_megatron_fsdp=True,
    cpu_offloading_num_layers=20,
)
...
LLAMA3_70B_GB200_64GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    micro_batch_size=2,
    use_megatron_fsdp=True,
...
LLAMA3_70B_GB200_64GPUS_FP8_MX_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
...
LLAMA3_70B_B200_64GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    tensor_model_parallel_size=2,
    pipeline_model_parallel_size=4,
...
LLAMA3_70B_B200_64GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    use_megatron_fsdp=True,
...
LLAMA3_70B_B200_64GPUS_FP8_MX_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    tensor_model_parallel_size=2,
    pipeline_model_parallel_size=4,
    virtual_pipeline_model_parallel_size=5,
...
LLAMA3_70B_H100_64GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
...
LLAMA3_70B_H100_64GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_70B_CONFIG,
    tensor_model_parallel_size=4,
...
LLAMA3_8B_GB300_8GPUS_BF16_PARALLEL_CONFIG = replace(
...
LLAMA3_8B_GB300_8GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=4,
    cuda_graph_impl="local",
    cuda_graph_scope="full_iteration",
...
LLAMA3_8B_GB200_8GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=2,
    cuda_graph_impl="local",
    cuda_graph_scope="full_iteration",
...
LLAMA3_8B_GB200_8GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=2,
)

LLAMA3_8B_GB200_8GPUS_FP8_MX_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=2,
    cuda_graph_impl="local",
    cuda_graph_scope="full_iteration",
...
LLAMA3_8B_B200_8GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=2,
    cuda_graph_impl="local",
    cuda_graph_scope="full_iteration",
...
LLAMA3_8B_B200_8GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    micro_batch_size=2,
    cuda_graph_impl="local",
    cuda_graph_scope="full_iteration",
...
LLAMA3_8B_H100_8GPUS_BF16_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    context_parallel_size=2,
)


LLAMA3_8B_H100_8GPUS_FP8_CS_PARALLEL_CONFIG = replace(
    BASE_LLAMA3_8B_CONFIG,
    use_megatron_fsdp=True,
)
