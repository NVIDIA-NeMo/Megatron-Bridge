...
COMBOS = [
    ...
    ("deepseek", "deepseek_v3", "pretrain", 256, "gb200", "fp8_mx", "partial_cg"),
    ("deepseek", "deepseek_v4_flash", "pretrain", 128, "gb200", "fp8_mx", "paged_stash"),
    ...
    ("deepseek", "deepseek_v3", "pretrain", 1024, "h100", "bf16", "deepep"),
    ("deepseek", "deepseek_v3", "pretrain", 1024, "h100", "fp8_cs"),
    ("deepseek", "deepseek_v3", "pretrain", 1024, "h100", "fp8_sc"),
    ("deepseek", "deepseek_v3", "pretrain", 1024, "h100", "fp8_sc", "deepep"),
    # Qwen3 MoE 30B-A3B
    ...
    ("qwen", "qwen3_30b_a3b", "pretrain", 16, "gb200", "bf16"),
    ("qwen", "qwen3_30b_a3b", "pretrain", 16, "gb200", "fp8_mx", "partial_cg"),
    ("qwen", "qwen3_30b_a3b", "pretrain", 16, "gb200", "fp8_mx", "paged_stash"),
    ...
    ("qwen", "qwen3_30b_a3b", "pretrain", 32, "h100", "bf16"),
    ("qwen", "qwen3_30b_a3b", "pretrain", 32, "h100", "fp8_sc"),
    ...
    ("qwen", "qwen3_235b_a22b", "pretrain", 64, "gb200", "fp8_mx", "paged_stash"),
    ("qwen", "qwen3_235b_a22b", "pretrain", 128, "gb200", "fp8_mx", "partial_cg"),
    ...
    ("qwen", "qwen3_235b_a22b", "pretrain", 256, "h100", "bf16", "hybridep"),
