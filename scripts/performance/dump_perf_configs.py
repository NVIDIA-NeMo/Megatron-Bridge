...
COMBOS = [
    ...
    ("gpt_oss", "gpt_oss_20b", "pretrain", 8, "gb300", "fp8_mx"),
    ("gpt_oss", "gpt_oss_20b", "pretrain", 8, "gb300", "nvfp4"),
    ("gpt_oss", "gpt_oss_20b", "pretrain", 8, "gb200", "fp8_mx"),
    ...
    ("gpt_oss", "gpt_oss_20b", "pretrain", 72, "gb300", "fp8_mx"),
    ("gpt_oss", "gpt_oss_20b", "pretrain", 72, "gb300", "nvfp4"),
    ("gpt_oss", "gpt_oss_20b", "pretrain", 72, "gb200", "fp8_mx"),
