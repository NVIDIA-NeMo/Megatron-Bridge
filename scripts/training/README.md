...
- `train.py` - Generic pretraining/finetuning for GPT- and Mamba-based models.
...
```bash
torchrun --nproc_per_node=8 train.py --recipe llama32_1b_pretrain_config
```

### Finetune

```bash
torchrun --nproc_per_node=8 train.py --recipe llama32_1b_finetune_config
```
...
# Gemma
torchrun --nproc_per_node=8 train.py --recipe gemma3_1b_pretrain_config

# Qwen
torchrun --nproc_per_node=8 train.py --recipe qwen3_8b_pretrain_config

# GPT
torchrun --nproc_per_node=8 train.py --recipe gpt_126m_pretrain_config
```
...
Use `--step` to choose the forward step implementation:
