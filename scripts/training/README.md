...
For choosing pretraining `.bin`/`.idx`, direct text SFT, hosted/local multimodal SFT, transitional prepared text SFT, or Energon data, see the [data tutorial index](../../tutorials/data/README.md).
