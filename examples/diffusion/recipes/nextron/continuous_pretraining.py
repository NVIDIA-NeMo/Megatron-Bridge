...
from megatron.bridge.diffusion.recipes.nextron.continuous_pretraining import (
    nextron_3b_finetune_config,
    nextron_8b_finetune_config,
    nextron_14b_finetune_config,
)
...
PRETRAIN_CONFIGS = {
    "3b": nextron_3b_finetune_config,
    "8b": nextron_8b_finetune_config,
    "14b": nextron_14b_finetune_config,
}
