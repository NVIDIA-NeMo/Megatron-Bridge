...
All scripts live under `examples/models/llada/llada15/`. They use the
container's bundled Bridge install (`/opt/Megatron-Bridge/src`) because that
path has a working `megatron.bridge.training` against the installed
Megatron-Core.
