...
# Usage: ./run_omni_modal_parallelism_tests.sh [--gpus N] [--config CONFIG_NAME]
#
# Examples:
#   ./run_omni_modal_parallelism_tests.sh                    # Run all configs with 8 GPUs
#   ./run_omni_modal_parallelism_tests.sh --gpus 4           # Run all configs with 4 GPUs
#   ./run_omni_modal_parallelism_tests.sh --config tp2_both  # Run only tp2_both config

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
TEST_FILE="${SCRIPT_DIR}/omni_modal_training_e2e.py"
