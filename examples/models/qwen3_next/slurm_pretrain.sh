...
# ==============================================================================
# Qwen3-Next 80B-A3B Pretraining
#
...
#SBATCH --job-name=qwen3next-pretrain
#SBATCH --nodes=4
...
#SBATCH --output=logs/qwen3_next_pretrain_%j.out
#SBATCH --error=logs/qwen3_next_pretrain_%j.err
#SBATCH --exclusive
...
echo "======================================"
echo "Qwen3-Next 80B-A3B Pretraining Job"
echo "======================================"
