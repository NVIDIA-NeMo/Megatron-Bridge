...
# ==============================================================================
# Qwen3-Next 80B-A3B Parameter-Efficient Fine-Tuning (PEFT) with LoRA
#
# Qwen3-Next 80B-A3B is a hybrid MoE language model with GDN linear attention
# layers. LoRA/DoRA significantly reduces memory. Supports multiple parallelism
# configs: each "TP,PP,EP,CP,SP" runs sequentially.
#
# Usage:
...
#SBATCH --job-name=qwen3next-lora
#SBATCH --nodes=2
...
#SBATCH --output=logs/qwen3_next_lora_%j.out
#SBATCH --error=logs/qwen3_next_lora_%j.err
#SBATCH --exclusive
...
# After pretrain, use e.g. ${WORKSPACE}/results/${MODEL_NAME}_pretrain_tp1_pp4_ep8_spTrue_cp1
PRETRAINED_CHECKPOINT=${PRETRAINED_CHECKPOINT:-${WORKSPACE}/models/Qwen3-Next-80B-A3B-Instruct/iter_0000000}
MODEL_NAME=qwen3_next_80b_a3b
DATASET_NAME=squad
SEQ_LENGTH=2048
TRAIN_ITERS=1000
...
echo "======================================"
echo "Qwen3-Next 80B-A3B LoRA Fine-Tuning Job"
echo "======================================"
