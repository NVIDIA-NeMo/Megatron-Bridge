...
DATASET_PATH="/path/to/your/dataset"  # Update this to the actual path of your dataset
SEQ_LENGTH=4096
TRAIN_ITERS=50
...
LR_WARMUP_ITERS=10
LOG_INTERVAL=1
WANDB_PROJECT=megatron-bridge-energon
...
for config in "${PARALLELISM_CONFIGS[@]}"; do
    ...
    uv run python -m torch.distributed.run --nproc_per_node=2 scripts/training/run_recipe.py \
        ...
        dataset.maker_kwargs="{"path_or_dataset": "$DATASET_PATH"}" \
