...
See the [sft_packed.sh](sft_packed.sh) script for for full parameter fine-tuning with sequence-packing.
...
See the [peft_packed.sh](peft_packed.sh) script for LoRA fine-tuning with sequence-packing.
