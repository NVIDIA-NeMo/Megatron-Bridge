...
GPU_PEAK_TFLOPS_PER_DEVICE=${GPU_PEAK_TFLOPS_PER_DEVICE:-}
...
if [[ -n "${GPU_PEAK_TFLOPS_PER_DEVICE}" ]]; then
    CMD+=(logger.peak_theoretical_tflops_per_gpu="${GPU_PEAK_TFLOPS_PER_DEVICE}")
fi
...
echo "[info] GPU_PEAK_TFLOPS_PER_DEVICE=${GPU_PEAK_TFLOPS_PER_DEVICE}"
