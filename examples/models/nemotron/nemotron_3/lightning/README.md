...
to preserve reasoning from all historical assistant turns. Thinking, final-answer, and structured tool-call tokens
inside assistant turns are supervised, while system, user, and tool-response tokens are masked.
