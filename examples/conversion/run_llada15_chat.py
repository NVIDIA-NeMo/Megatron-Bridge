...
Usage::
    ...
    PYTHONPATH=/opt/Megatron-Bridge/src python3 \\
        examples/conversion/run_llada15_chat.py \\
        --ckpt-path /linnanw/llada15_megatron_ckpt \\
        --tokenizer-path /linnanw/home/.cache/huggingface/hub/models--GSAI-ML--LLaDA-1.5/snapshots/84346fd91ba60252d260022201ad6fc5a3468fb2 \\
...
def setup_distributed_single_gpu():
    """Initialize a single-GPU, single-rank NCCL process group if needed."""
...
def main():
    """Run interactive LLaDA-1.5 chat generation from a Megatron checkpoint."""
