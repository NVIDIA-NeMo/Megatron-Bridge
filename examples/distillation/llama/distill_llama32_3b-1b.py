...
def main() -> None:
    ...
    Examples of CLI usage:
        ...
        uv run -m torch.distributed.run --nproc_per_node=2 distill_llama32_3b-1b.py --config-file my_config.yaml \
            train.train_iters=50000

        # Multiple overrides for distributed training
        uv run -m torch.distributed.run --nproc_per_node=8 distill_llama32_3b-1b.py \
            model.tensor_model_parallel_size=4 \
