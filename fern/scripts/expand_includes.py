...
Processes index.mdx and releases/changelog.mdx, replacing {include} blocks
with the actual content of the referenced files (README.md, CHANGELOG.md).
"""
...
def expand_include_in_content(
    ...
    def replace_include(match: re.Match[str]) -> str:
        ...
        # e.g. docs/releases/changelog.md has ../../CHANGELOG.md -> repo_root/CHANGELOG.md
...
def main() -> None:
    ...
    expanded = []
    for pattern in ["index.mdx", "releases/changelog.mdx"]:
