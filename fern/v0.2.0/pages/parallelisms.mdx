...
![Distributed Data Parallelism](/assets/training/images/ddp.gif)
...
For more optimizer options, refer to the [`bridge.training.config.OptimizerConfig`](https://docs.nvidia.com/nemo/megatron-bridge/latest/apidocs/bridge/bridge.training.config.OptimizerConfig.html) API documentation.
...
![Tensor Parallelism Overview](/assets/training/images/tp1.png)
*Figure 1: Tensor Parallelism distributes individual layer parameters across multiple GPUs.*

![Tensor Parallelism Implementation](/assets/training/images/tp2.png)
...
![Pipeline Parallelism](/assets/training/images/pp.gif)
...
![Expert Parallelism](/assets/training/images/ep.png)
...
![Sequence Parallelism](/assets/training/images/sp.png)
