...
![canonical_lora.png](/assets/training/images/canonical_lora.png)

![performant_lora.png](/assets/training/images/performant_lora.png)
...
1. **Base PEFT Class**: All PEFT methods inherit from the abstract [`bridge.peft.base.PEFT`](https://docs.nvidia.com/nemo/megatron-bridge/latest/apidocs/bridge/bridge.peft.base.PEFT.html) base class, which defines the core interface for module transformation.
