...
def gpt_oss_120b_pretrain_64gpu_gb300_bf16_ncclep_config() -> ConfigContainer:
    """GPT-OSS 120B pretrain: 64× GB300, BF16, NCCL EP=64."""
    cfg = gpt_oss_120b_pretrain_64gpu_gb300_bf16_config()
    # The BF16 parent leaves comm_overlap unset, so keep the A2A overlap off here too.
    _enable_ncclep(cfg, mxfp8=False, moe_a2a_overlap=False)
    return cfg


def gpt_oss_120b_pretrain_64gpu_gb300_fp8mx_ncclep_config() -> ConfigContainer:
    """GPT-OSS 120B pretrain: 64× GB300, FP8-MX, NCCL EP=16."""
