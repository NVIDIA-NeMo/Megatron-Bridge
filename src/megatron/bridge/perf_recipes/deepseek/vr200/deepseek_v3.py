...
def deepseek_v3_pretrain_512gpu_vr200_fp8mx_config() -> ConfigContainer:
    """DeepSeek V3 pretrain: 512× VR200, FP8-MX, GBS scaled from the 256-GPU recipe."""
...
def deepseek_v3_pretrain_1024gpu_vr200_fp8mx_config() -> ConfigContainer:
    """DeepSeek V3 pretrain: 1024× VR200, FP8-MX, GBS scaled from the 256-GPU recipe."""
    cfg = deepseek_v3_pretrain_256gpu_vr200_fp8mx_config()
