from megatron.bridge.perf_recipes.deepseek.b200.deepseek_v3 import (
    ...
    deepseek_v3_256gpu_b200_fp8mx_deepep_pretrain_config,
...
from megatron.bridge.perf_recipes.deepseek.gb200.deepseek_v4 import (
    deepseek_v4_flash_128gpu_gb200_fp8mx_paged_stash_pretrain_config,
)
...
from megatron.bridge.perf_recipes.deepseek.h100.deepseek_v3 import (
    ...
    deepseek_v3_1024gpu_h100_bf16_deepep_pretrain_config,
    deepseek_v3_pretrain_1024gpu_h100_fp8cs_config,
    deepseek_v3_pretrain_1024gpu_h100_fp8sc_config,
    deepseek_v3_1024gpu_h100_fp8sc_deepep_pretrain_config,
