...
def llama31_8b_pretrain_72gpu_gb200_nvfp4_config() -> ConfigContainer:
    """Llama3.1 8B pretrain: 72× GB200, NVFP4."""
    cfg = llama31_8b_pretrain_config()
    cfg.mixed_precision = _perf_precision("nvfp4")
    cfg.mixed_precision.num_layers_at_start_in_bf16 = 0
    cfg.mixed_precision.num_layers_at_end_in_bf16 = 0
...
def llama31_8b_pretrain_512gpu_gb200_fp8cs_config() -> ConfigContainer:
    """Llama3.1 8B pretrain: 512× GB200, FP8 current-scaling."""
    cfg = llama31_8b_pretrain_config()
