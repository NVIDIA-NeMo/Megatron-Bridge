...
def evaluate(
    ...
    Args:
        ...
        p2p_communicator (Optional[Union[P2PCommunicator, MultiModulePipelineCommunicator]], optional):
            ...
            For OmniModal models, pass a MultiModulePipelineCommunicator. Defaults to None.
        pg_collection (Optional[Union[ProcessGroupCollection, MultiModuleProcessGroupCollection]], optional):
            ...
            For OmniModal models, pass a MultiModuleProcessGroupCollection. Defaults to None.
    ...
    # Determine if this is a multimodule evaluation (OmniModal)
    ...
    if is_multimodule and not isinstance(p2p_communicator, MultiModulePipelineCommunicator):
        raise ValueError(
            "Multimodule (OmniModal) evaluation requires an explicit MultiModulePipelineCommunicator as p2p_communicator."
        )
