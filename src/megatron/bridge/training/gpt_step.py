...
def get_batch_from_iterator(
    ...
    if get_attention_mask_from_fusion:
        # attention_mask is not needed to be passed and is generated by the attn backend.
        # This helps bw to not copy from host to device.
