...
class GPTDatasetConfig(MCoreGPTDatasetConfig, DataloaderConfig):
    ...
    """If set to True, enables individual validation loss tracking for each validation dataset
    instead of aggregating them together. When enabled, valid_ds will be a list of datasets
    instead of a single blended dataset."""
