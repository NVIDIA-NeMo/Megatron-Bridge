...
class ValidationConfig:
    ...
    """Validation micro batch size. If None, uses TrainingConfig.micro_batch_size."""

    val_global_batch_size: int | None = None
    """Validation global batch size. If None, uses TrainingConfig.global_batch_size."""
