...
class GPTDatasetConfig(MCoreGPTDatasetConfig, DataloaderConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # If seq_length is provided, use it to set sequence_length
        self.seq_length = seq_length
        self.skip_getting_attention_mask_from_dataset = skip_getting_attention_mask_from_dataset
        assert self.seq_length is not None, "seq_length parameter must be specified."
        kwargs['sequence_length'] = self.seq_length
