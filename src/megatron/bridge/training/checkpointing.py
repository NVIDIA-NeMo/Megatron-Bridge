...
def _load_global_dist_base_checkpoint(
    ...
    # Remove _extra_state keys before loading. Bridge-converted checkpoints
    # don't contain _extra_state (TE/FP8 metadata), so the dist checkpoint
    # planner would fail trying to find them in the checkpoint.
