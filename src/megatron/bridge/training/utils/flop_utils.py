...
def num_floating_point_operations(cfg: ConfigContainer, batch_size: int = 1):
    ...
    # If the model has a custom TFLOPS calculation method, use it.
    if hasattr(cfg.model, "get_num_floating_point_operations"):
        return cfg.model.get_num_floating_point_operations(batch_size)
