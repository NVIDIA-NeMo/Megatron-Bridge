    ...
    def transformer_flops():
        ...
        if cfg.model.multi_latent_attention:
            ...
            if experimental_attention_variant == "dsv4_hybrid":
                ...
                # MCore main and dev use different names for the same projection geometry.
                if hasattr(cfg.model, "output_projection_lora_rank"):
                    o_lora_rank = cfg.model.output_projection_lora_rank
                    o_groups = cfg.model.output_projection_groups
                else:
                    o_lora_rank = cfg.model.o_lora_rank
                    o_groups = cfg.model.o_groups
