...
class Flux(VisionModule):
    ...
    Args:
        config: Exact MCore transformer configuration.
        model_config: Optional outer FLUX architecture configuration. Legacy
            providers may omit it because they carry both sets of fields.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        architecture_config = model_config if model_config is not None else config
