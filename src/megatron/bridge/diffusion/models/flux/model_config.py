...
@dataclass
class FluxTransformerConfig(TransformerConfig):
    """Nested transformer and architecture settings consumed by FLUX."""
...
__all__ = ["FluxModelBuilder", "FluxModelConfig", "FluxTransformerConfig"]
