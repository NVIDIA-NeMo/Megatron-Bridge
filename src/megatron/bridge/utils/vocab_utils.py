...
def calculate_padded_vocab_size(
    ...
    Args:
        vocab_size: The original vocabulary size.
        make_vocab_size_divisible_by: Base divisibility requirement.
        tensor_model_parallel_size: Number of tensor-parallel ranks.
        logging_enabled: Whether to log the padding decision.
...
def _calculate_padded_vocab_size_cached(
    ...
    """Calculate padded vocab size with argument validation and caching."""
    if vocab_size <= 0:
