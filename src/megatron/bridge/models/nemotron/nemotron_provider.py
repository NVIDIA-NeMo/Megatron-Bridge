...
class NemotronModelProvider(GPTModelProvider):
    ...
    ffn_hidden_size: Optional[int] = 9216
...
class Nemotron3ModelProvider8B(NemotronModelProvider):
    ...
    ffn_hidden_size: Optional[int] = 16384
    num_attention_heads: int = 48  # Updated to match HF model (was 32)
    num_query_groups: Optional[int] = 8  # Updated to match HF model (was None)
...
class Nemotron3ModelProvider22B(NemotronModelProvider):
    ...
    ffn_hidden_size: Optional[int] = 24576
