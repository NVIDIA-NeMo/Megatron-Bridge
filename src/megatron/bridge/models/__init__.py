...
# vlm2 branch of Megatron-LM removed ProcessGroupCollection from
# megatron.core.process_groups_config, which olmoe_provider.py imports.
# Guard so the rest of Bridge still loads with the vlm2 submodule.
try:
