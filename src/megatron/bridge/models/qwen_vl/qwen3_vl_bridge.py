...
class Qwen3VLBridge(MegatronModelBridge):
    ...
    def provider_bridge(self, hf_pretrained: PreTrainedVLM) -> Qwen3VLModelProvider:
        ...
        # 给rope加上一个默认值，使用兼容函数提取rope_theta
        ...
        provider = Qwen3VLModelProvider(
            ...
            rotary_scaling_factor=text_config.rope_scaling.get("factor", 1.0) if hasattr(text_config, "rope_scaling") and isinstance(text_config.rope_scaling, dict) else 1.0,
