...
"""Custom Megatron-Core modules for Gemma2 models."""
...
class Gemma2DotProductAttention(MegatronModule):
    ...
    def __init__(
        ...
        query_pre_attn_scalar: float = 224.0,
        ...
        **kwargs,
        ...
        coeff = None
        self.norm_factor = math.sqrt(query_pre_attn_scalar)
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Gemma 2 specific:
        matmul_result = logit_softcapping(matmul_result, self.attn_logit_softcapping)
...
class Gemma2FlexDotProductAttention(Gemma2DotProductAttention):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.softcap = float(self.attn_logit_softcapping or 0.0)
...
class Gemma2OutputLayer(ColumnParallelLinear):
    ...
    def forward(self, *args, **kwargs):
        ...
        output = logit_softcapping(output, self.final_logit_softcapping)
        return output, bias
...
def gemma2_layer_spec(model_config: "Gemma2ModelConfig") -> ModuleSpec:
            ...
            self_attention=ModuleSpec(
                ...
                submodules=SelfAttentionSubmodules(
                    ...
                    core_attention=ModuleSpec(
                        module=Gemma2FlexDotProductAttention,
                        params={
