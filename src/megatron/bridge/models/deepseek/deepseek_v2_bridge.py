...
@MegatronModelBridge.register_bridge(
    source=get_causal_lm_class_via_auto_map(model_name_or_path="deepseek-ai/DeepSeek-V2"), target=GPTModel
)
@MegatronModelBridge.register_bridge(
    source=get_causal_lm_class_via_auto_map(model_name_or_path="deepseek-ai/DeepSeek-V2-Chat"),
    target=GPTModel,
)
class DeepSeekV2Bridge(MegatronModelBridge):
    ...
    Example:
        ...
        >>> bridge = AutoBridge.from_hf_pretrained("deepseek-ai/DeepSeek-V2")
