...
from megatron.bridge.models.deepseek.deepseek_provider import DeepSeekV2LiteProvider
from megatron.bridge.models.hf_pretrained.causal_lm import PreTrainedCausalLM


@MegatronModelBridge.register_bridge(
    source=get_causal_lm_class_via_auto_map(model_name_or_path="deepseek-ai/DeepSeek-V2-Lite"), target=GPTModel
)
@MegatronModelBridge.register_bridge(
    source=get_causal_lm_class_via_auto_map(model_name_or_path="deepseek-ai/DeepSeek-V2-Lite-Chat"),
    target=GPTModel,
)
class DeepSeekV2LiteBridge(MegatronModelBridge):
    """
    Megatron Hub Bridge for DeepSeek-V2-Lite
    ...
    def provider_bridge(self, hf_pretrained: PreTrainedCausalLM) -> DeepSeekV2LiteProvider:
