...
from megatron.bridge.models.deepseek.deepseek_provider import DeepSeekV3Config
...
class DeepSeekV3Bridge(MegatronModelBridge):
    """
    Megatron Hub Bridge for DeepSeekV3 Causal LM.
    ...
    def provider_bridge(self, hf_pretrained: PreTrainedCausalLM) -> DeepSeekV3Config:
        hf_config = hf_pretrained.config

        provider = DeepSeekV3Config(
