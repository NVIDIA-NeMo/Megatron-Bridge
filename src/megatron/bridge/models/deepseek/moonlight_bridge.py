...
from megatron.bridge.models.deepseek.deepseek_provider import MoonlightProvider
from megatron.bridge.models.hf_pretrained.causal_lm import PreTrainedCausalLM


@MegatronModelBridge.register_bridge(
    source=get_causal_lm_class_via_auto_map(model_name_or_path="moonshotai/Moonlight-16B-A3B"), target=GPTModel
)
@MegatronModelBridge.register_bridge(
    source=get_causal_lm_class_via_auto_map(model_name_or_path="moonshotai/Moonlight-16B-A3B-Instruct"),
    target=GPTModel,
)
class MoonlightBridge(MegatronModelBridge):
    """
    Megatron Hub Bridge for Moonlight-16B-A3B, which is a variant of DeepSeek-V3.
    ...
    def provider_bridge(self, hf_pretrained: PreTrainedCausalLM) -> MoonlightProvider:
