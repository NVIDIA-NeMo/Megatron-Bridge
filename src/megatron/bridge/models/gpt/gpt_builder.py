...
class GPTModelConfig(ModelConfig):
    ...
    builder: ClassVar[str] = "megatron.bridge.models.GPTModelBuilder"
...
class GPTModelBuilder(ModelBuilder[MCoreGPTModel, GPTModelConfig]):
    ...
    def build_model(
        ...
        if self._model_config.use_transformer_engine_full_layer_spec:
