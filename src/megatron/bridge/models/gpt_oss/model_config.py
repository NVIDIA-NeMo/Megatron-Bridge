...
class GPTOSSModelConfig(BridgeGPTModelConfig):
    """Serializable GPT-OSS GPTModel configuration."""
...
class GPTOSSModelBuilder(GPTModelBuilder):
    """Build GPT-OSS as the GPTModel architecture used by current main."""
    ...
    def build_model(
        ...
        """Build one GPT-OSS pipeline stage with explicit YaRN construction."""
