...
def gpt_oss_20b_pretrain_config() -> ConfigContainer:
    ...
    # Model config
    cfg.model = AutoBridge.from_hf_pretrained("openai/gpt-oss-20b").to_megatron_model_config(load_weights=False)
...
def gpt_oss_120b_pretrain_config() -> ConfigContainer:
    ...
    # Model config
    cfg.model = AutoBridge.from_hf_pretrained("openai/gpt-oss-120b").to_megatron_model_config(load_weights=False)
