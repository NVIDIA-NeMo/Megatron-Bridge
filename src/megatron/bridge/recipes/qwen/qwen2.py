...
def qwen2_500m_pretrain_config() -> ConfigContainer:
    ...
    cfg.model = AutoBridge.from_hf_pretrained("Qwen/Qwen2-0.5B").to_megatron_model_config(load_weights=False)
...
def qwen2_1p5b_pretrain_config() -> ConfigContainer:
    ...
    # Model config (--tensor-model-parallel-size, --pipeline-model-parallel-size, etc.)
    cfg.model = AutoBridge.from_hf_pretrained("Qwen/Qwen2-1.5B").to_megatron_model_config(load_weights=False)
...
def qwen2_7b_pretrain_config() -> ConfigContainer:
    ...
    cfg.model = AutoBridge.from_hf_pretrained("Qwen/Qwen2-7B").to_megatron_model_config(load_weights=False)
...
def qwen2_72b_pretrain_config() -> ConfigContainer:
    ...
    # Model config
    cfg.model = AutoBridge.from_hf_pretrained("Qwen/Qwen2-72B").to_megatron_model_config(load_weights=False)
...
def qwen25_500m_pretrain_config() -> ConfigContainer:
    ...
    # Model config (--tensor-model-parallel-size, --pipeline-model-parallel-size, etc.)
    cfg.model = AutoBridge.from_hf_pretrained("Qwen/Qwen2.5-0.5B").to_megatron_model_config(load_weights=False)
...
def qwen25_1p5b_pretrain_config() -> ConfigContainer:
    ...
    # Model config
    cfg.model = AutoBridge.from_hf_pretrained("Qwen/Qwen2.5-1.5B").to_megatron_model_config(load_weights=False)
...
def qwen25_7b_pretrain_config() -> ConfigContainer:
    ...
    # Model config
    cfg.model = AutoBridge.from_hf_pretrained("Qwen/Qwen2.5-7B").to_megatron_model_config(load_weights=False)
...
def qwen25_14b_pretrain_config() -> ConfigContainer:
    ...
    # Model config
    cfg.model = AutoBridge.from_hf_pretrained("Qwen/Qwen2.5-14B").to_megatron_model_config(load_weights=False)
...
def qwen25_32b_pretrain_config() -> ConfigContainer:
    ...
    # Model config
    cfg.model = AutoBridge.from_hf_pretrained("Qwen/Qwen2.5-32B").to_megatron_model_config(load_weights=False)
...
def qwen25_72b_pretrain_config() -> ConfigContainer:
    ...
    # Model config
    cfg.model = AutoBridge.from_hf_pretrained("Qwen/Qwen2.5-72B").to_megatron_model_config(load_weights=False)
