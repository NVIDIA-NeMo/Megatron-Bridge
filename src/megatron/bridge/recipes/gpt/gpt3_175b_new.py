...
"""
GPT3-175B recipe using the new flattened layout with _pretrain_common.
...
GPT3-175B is a 175B dense model with:
- Uses GPTProvider175B
- TP=4, PP=8, VP=6, SP=True
- Communication overlap enabled with userbuffers config
- lr=0.9e-4 (different from default 3e-4)

Key differences from _pretrain_common:
- train_iters=1_168_251 (vs 300000)
- global_batch_size=2048 (vs 32)
- micro_batch_size=2 (same)
- seq_length=2048 (vs 4096)
- lr=0.9e-4 (vs 3e-4)
