...
"""
DeepSeek V3 recipe using the new flattened layout with _pretrain_common.
...
DeepSeek V3 is a 671B MoE model with Multi-Token Prediction (MTP) support.
Key differences from _pretrain_common:
- Uses precision-aware optimizer with bfloat16 gradients/moments
- Custom MixedPrecisionConfig (not "bf16_mixed" string)
- MTP (Multi-Token Prediction) enabled by default
