...
"""
Gemma3 model recipes with parameterless API.

This module provides pre-configured SFT and PEFT configs for Gemma3 model variants.
All configs follow the parameterless API pattern - returning a ConfigContainer
with all settings pre-configured.

Model variants:
- gemma3_1b: 1B parameters (dense model)
"""
