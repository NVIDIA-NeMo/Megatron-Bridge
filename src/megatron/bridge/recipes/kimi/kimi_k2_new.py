...
"""
Kimi-K2 recipe using the new flattened layout with _pretrain_common.
...
Kimi-K2 is a 1T MoE model with unique characteristics:
- Uses KimiK2Provider instead of AutoBridge.from_hf_pretrained
- Uses Muon optimizer by default (requires overlap_param_gather=False, use_distributed_optimizer=False)
- Custom MixedPrecisionConfig (not "bf16_mixed" string)
...
- train_iters=1_000_000 (vs 300000)
- global_batch_size=4096 (vs 32)
- micro_batch_size=1 (vs 2)
- lr_warmup_iters=2000 (vs 500)
- eval_interval=2000 (vs 500)
- save_interval=2000 (vs 500)
- DDP: overlap_param_gather=False, use_distributed_optimizer=False (for Muon)
"""
