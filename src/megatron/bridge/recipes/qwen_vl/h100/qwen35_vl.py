...
def qwen35_vl_35b_a3b_pretrain_16gpu_h100_bf16_functional_config() -> ConfigContainer:
    ...
    # layer-norm, and MoE activation scopes while retaining the measured
    # parallel layout and TE CUDA graphs.
    cfg.model.recompute_granularity = "selective"
    cfg.model.recompute_modules = ["core_attn", "gdn_norm_out", "layernorm", "moe_act"]
