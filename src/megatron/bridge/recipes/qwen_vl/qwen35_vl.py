...
# =============================================================================
# Qwen3.5-VL MoE Pretrain Configurations (35B-A3B, 122B-A10B, 397B-A17B)
# =============================================================================


def _qwen35_vl_pretrain_common(
    hf_path: str,
    *,
    tp: int,
    pp: int,
    ...
    """Build a pretrain ConfigContainer for a Qwen3.5-VL MoE model.

    Composes _pretrain_common() with Qwen3.5-VL-specific model, VLM,
    MoE, and optional precision/overlap/dispatcher settings.
    """
    ...
    # Dataset — mock by default for performance benchmarks
    if mock:
    ...
    cfg.model.moe_token_dispatcher_type = "alltoall"
    cfg.model.moe_flex_dispatcher_backend = moe_flex_dispatcher_backend or "deepep"
    ...
    # Memory saving (disabled by default; enable per-model as needed)
    cfg.model.recompute_granularity = None
...
def qwen35_vl_35b_a3b_pretrain_config(
    mock: bool = True,
    precision_config: MixedPrecisionConfig | str | None = None,
    comm_overlap_config: CommOverlapConfig | None = None,
    moe_flex_dispatcher_backend: str | None = None,
) -> ConfigContainer:
    """Return a pretrain config for Qwen3.5-VL 35B-A3B (MoE).
    ...
    Args:
        mock: Whether to use mock data (default True for benchmarks).
        precision_config: Mixed-precision configuration.
        comm_overlap_config: Communication overlap configuration.
        moe_flex_dispatcher_backend: Flex dispatcher backend for MoE.
    """
    return _qwen35_vl_pretrain_common(
...
def qwen35_vl_122b_a10b_pretrain_config(
    mock: bool = True,
    precision_config: MixedPrecisionConfig | str | None = None,
    comm_overlap_config: CommOverlapConfig | None = None,
    moe_flex_dispatcher_backend: str | None = None,
) -> ConfigContainer:
    """Return a pretrain config for Qwen3.5-VL 122B-A10B (MoE).

    Default configuration: 4 nodes, 32 GPUs
    - TP=2, PP=6, EP=8
    - Sequence length: 4096
    - Activation recomputation enabled (large model).
    ...
    Args:
        ...
        moe_flex_dispatcher_backend: Flex dispatcher backend for MoE.
    """
    cfg = _qwen35_vl_pretrain_common(
...
def qwen35_vl_397b_a17b_pretrain_config(
    mock: bool = True,
    precision_config: MixedPrecisionConfig | str | None = None,
    comm_overlap_config: CommOverlapConfig | None = None,
    moe_flex_dispatcher_backend: str | None = None,
) -> ConfigContainer:
    """Return a pretrain config for Qwen3.5-VL 397B-A17B (MoE).
