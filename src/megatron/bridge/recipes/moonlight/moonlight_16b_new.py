...
"""
Moonlight-16B model recipes with parameterless API.

This module provides pre-configured SFT and PEFT configs for Moonlight-16B model.
...
Note: Moonlight-16B is an MoE (Mixture of Experts) model with 16B parameters.
It uses MoonlightModelProvider16B instead of AutoBridge.from_hf_pretrained().

Model variants:
- moonlight_16b: 16B parameters (MoE model)
"""
