...
"""Base class for OmniModal dataset providers."""
...
class OmniModalDatasetProvider(DatasetProvider):
    """Abstract base class for OmniModal dataset providers.

    All OmniModal dataset providers must inherit from this class and implement
    the required methods. This ensures a consistent interface for OmniModal
    data loading.
    ...
    Example:
        >>> class MyOmniModalProvider(OmniModalDatasetProvider):
