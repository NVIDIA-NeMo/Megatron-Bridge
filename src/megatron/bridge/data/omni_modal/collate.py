...
"""Collate functions for OmniModal datasets."""
...
def omni_modal_collate_fn(
    batch: List[Dict[str, Any]],
    modality_names: List[str],
) -> Dict[str, Any]:
    """Collate function for OmniModal datasets.

    Stacks batch items and organizes modality inputs into a structure
    suitable for OmniModal model forward pass.

    Args:
        batch: List of examples from OmniModalDataset, each containing:
    ...
    Example:
        ...
        ...     # ... more examples
        ... ]
        >>> collated = omni_modal_collate_fn(batch, modality_names=["vision"])
    """
    if not batch:
        return {}
