...
"""HuggingFace dataset provider for OmniModal multi-encoder models."""
...
class HFOmniModalDatasetProvider(OmniModalDatasetProvider):
    """DatasetProvider for OmniModal models using HuggingFace datasets.
    ...
    that OmniModal encoder modules consume during training.

    For testing with synthetic data, use MockOmniModalProvider instead.
