...
"""Mock dataset provider for OmniModal testing with synthetic multimodal data.
...
class MockOmniModalProvider(OmniModalDatasetProvider):
    """DatasetProvider for mock OmniModal datasets with synthetic multimodal data.
    ...
    def _load_tokenizer(self) -> Any:
        ...
        if not self.tokenizer_path:
            raise ValueError(
                "tokenizer_path must be set for MockOmniModalProvider. "
    ...
    ) -> Tuple[Optional[OmniModalDataset], Optional[OmniModalDataset], Optional[OmniModalDataset]]:
    ...
    def get_collate_fn(self) -> Callable:
        """Return collate function for OmniModal datasets.

        Returns:
            Partial function of omni_modal_collate_fn with modality names pre-filled.
        """
