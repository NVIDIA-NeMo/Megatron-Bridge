...
def build_train_valid_test_data_loaders(
    ...
    eval_gbs = cfg.validation.eval_global_batch_size if cfg.validation.eval_global_batch_size is not None else cfg.train.global_batch_size
    eval_mbs = cfg.validation.eval_micro_batch_size if cfg.validation.eval_micro_batch_size is not None else cfg.train.micro_batch_size
