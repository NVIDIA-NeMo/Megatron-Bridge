...
from nemo_lm.models.llama import Llama31Config8B
...
def model_config(
    ...
    """
    Configure the Llama31 8B model.
    ...
    Returns:
        Llama31Config8B: Configuration for the Llama3 8B model.
    """
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Llama31 8B model.
