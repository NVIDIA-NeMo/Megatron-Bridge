...
from nemo_lm.models.llama import Llama31Config405B
...
def model_config(
    ...
    """
    Configure the Llama31 405B model.
    ...
    Returns:
        Llama3Config8B: Configuration for the Llama31 405B model.
    """
    return Llama31Config405B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Llama31 405B model.
