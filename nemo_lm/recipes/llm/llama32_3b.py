...
from nemo_lm.models.llama import Llama32Config3B
...
def model_config(
    ...
    """
    Configure the Llama32 3B model.
    ...
    Returns:
        Llama32Config3B: Configuration for the Llama32 3B model.
    """
    return Llama32Config3B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Llama32 3B model.
