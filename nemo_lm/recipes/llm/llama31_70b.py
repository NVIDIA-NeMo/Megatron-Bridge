...
from nemo_lm.models.llama import Llama31Config70B
...
def model_config(
    ...
    """
    Configure the Llama31 70B model.
    ...
    Returns:
        Llama31Config70B: Configuration for the Llama31 70B model.
    """
    return Llama31Config70B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Llama31 70B model.
