...
For Bridge-native FSDP behavior and constraints, also read @skills/mbridge-perf-megatron-fsdp/SKILL.md.
...
For general Slurm debugging and multi-node patterns, read @skills/mbridge-multi-node-slurm/SKILL.md.
