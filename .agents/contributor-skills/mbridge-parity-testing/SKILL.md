---
name: mbridge-parity-testing
description: Structured framework for verifying numerical parity of HF<->MCore weight conversions. References existing tools and the mbridge-adding-model-support skill.
...
`mbridge-adding-model-support` skill.
...
`mbridge-adding-model-support` skill (Milestone 3, Phase 6).
...
4. **Use the debugging script template** from the `mbridge-adding-model-support` skill
...
Pitfalls section of the `mbridge-adding-model-support` skill.
