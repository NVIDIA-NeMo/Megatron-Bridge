#!/bin/bash
# Usage:
#   Normal run: ./run_llama3_70b_fp4.sh
#   Deterministic mode: DETERMINISTIC=true ./run_llama3_70b_fp4.sh
#   Deterministic with Flash Attention: DETERMINISTIC=true BACKEND=flash ./run_llama3_70b_fp4.sh
set -euo pipefail
source ../../secrets.sh
...
# CPU activation offloading (compatible with CUDA graphs)
...
python scripts/performance/setup_experiment.py \
    ...
    -wdj "llama3-70b-fp4-nemo-25.11-${EXP_NAME}" \
    --task pretrain \
